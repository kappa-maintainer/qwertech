...
public class QT_Food_Renderer implements IItemRenderer {
    ...
    public void renderModel(short[] primary, short[] secondary, ModelBaseTool model, ItemStack item, Entity entity,
        float f, float f1, float f2, float f3, float f4, float f5, ResourceLocation texture, int rotatex, int rotatey,
        int rotatez, float translatex, float translatey, float translatez) {
    ...
    public void renderType(short[] primary, short[] secondary, String type, ItemStack item, Entity entity,
        boolean isFP) {
        if (type.equals("club")) {
            if (!isFP) {
                renderModel(
            ...
            if (!isFP) {
                renderModel(
                    ...
                    0.0F,
                    0.0625F,
                    new ResourceLocation("qwertech:textures/entity/egg.png"),
                    0,
                    0,
                    -130,
                    0.8F,
