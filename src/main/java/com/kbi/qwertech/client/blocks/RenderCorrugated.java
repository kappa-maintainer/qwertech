...
public class RenderCorrugated implements ISimpleBlockRenderingHandler {
    ...
    public void rendP(double x1, double y1, double z1, double u1, double v1, double x2, double y2, double z2, double u2,
        double v2) {
        tav(x2, y1, z2, u2, v2);
        tav(x2, y2, z2, u2, v1);
        tav(x1, y2, z1, u1, v1);
    ...
    public void rendY(double x1, double y1, double z1, double u1, double v1, double x2, double y2, double z2, double u2,
        double v2) {
        tav(x2, y1, z1, u2, v1);
        tav(x2, y1, z2, u2, v2);
        tav(x1, y1, z2, u1, v2);
    ...
    public void rendYXA(double x1, double y1, double z1, double u1, double v1, double x2, double y2, double z2,
        double u2, double v2, double width) {
    ...
    public void rendYZA(double x1, double y1, double z1, double u1, double v1, double x2, double y2, double z2,
        double u2, double v2, double width) {
    ...
    public void rendCX(double x1, double y1, double z1, double u1, double v1, double x2, double y2, double z2,
        double u2, double v2, double width) {
    ...
    public void rendCZ(double x1, double y1, double z1, double u1, double v1, double x2, double y2, double z2,
        double u2, double v2, double width) {
    ...
    public void renderWall(IIcon icon, boolean isNorth, boolean offset, int posx, int posy, int posz) {
        ...
        for (int q = 0; q < 17; q++) {
            if (offset) {
                u[q] = icon.getInterpolatedU(Math.min(16, q + 3));
            } else {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        tessellator = Tessellator.instance;
        boolean renderEast = world.isSideSolid(x - 1, y, z, ForgeDirection.WEST, true)
            || world.getBlock(x - 1, y, z) == block;
        boolean renderWest = world.isSideSolid(x + 1, y, z, ForgeDirection.EAST, true)
            || world.getBlock(x + 1, y, z) == block;
        boolean renderNorth = world.isSideSolid(x, y, z - 1, ForgeDirection.SOUTH, true)
            || world.getBlock(x, y, z - 1) == block;
        boolean renderSouth = world.isSideSolid(x, y, z + 1, ForgeDirection.NORTH, true)
            || world.getBlock(x, y, z + 1) == block;
