...
public class GT_Tool_Renderer implements IItemRenderer {
    ...
    public boolean handleRenderType(ItemStack item, ItemRenderType type) {
        if (item.getItemDamage() == 48 || item.getItemDamage() == 22
            || item.getItemDamage() == 34
            || item.getItemDamage() == 36
            || item.getItemDamage() == 40
            || item.getItemDamage() == 16
            || item.getItemDamage() == 20
            || item.getItemDamage() == 24
            || item.getItemDamage() == 12
            || item.getItemDamage() == 14
            || item.getItemDamage() == 58) {
            switch (type) {
                case EQUIPPED:
                ...
                switch (type) {
                    ...
                    // case EQUIPPED_FIRST_PERSON:
                    {
                        renderModel(
                            ...
                            0.0F,
                            0.0625F,
                            new ResourceLocation("qwertech:textures/items/modeled/hammer.png"),
                            0,
                            0,
                            -20,
                            -0.1F,
                ...
                switch (type) {
                    case EQUIPPED: {
                        renderModel(
                            ...
                            0.0F,
                            0.0625F,
                            new ResourceLocation("qwertech:textures/items/modeled/screwdriver.png"),
                            0,
                            0,
                            -130,
                            0.8F,
                ...
                switch (type) {
                    case EQUIPPED: {
                        renderModel(
                            ...
                            0.0F,
                            0.0625F,
                            new ResourceLocation("qwertech:textures/items/modeled/chisel.png"),
                            0,
                            0,
                            -130,
                            0.8F,
                ...
                switch (type) {
                    ...
                    // case EQUIPPED_FIRST_PERSON:
                    {
                        renderModel(
                            ...
                            0.0F,
                            0.0625F,
                            new ResourceLocation("qwertech:textures/items/modeled/knife.png"),
                            0,
                            0,
                            -20,
                            -0.1F,
                ...
                switch (type) {
                    ...
                    // case EQUIPPED_FIRST_PERSON:
                    {
                        renderModel(
                            ...
                            0.0F,
                            0.0625F,
                            new ResourceLocation("qwertech:textures/items/modeled/bigknife.png"),
                            0,
                            0,
                            -20,
                            -0.1F,
                ...
                switch (type) {
                    ...
                    // case EQUIPPED_FIRST_PERSON:
                    {
                        renderModel(
                            ...
                            0.0F,
                            0.0625F,
                            new ResourceLocation("qwertech:textures/items/modeled/crowbar.png"),
                            0,
                            0,
                            -20,
                            -0.1F,
                ...
                switch (type) {
                    ...
                    // case EQUIPPED_FIRST_PERSON:
                    {
                        renderModel(
                            ...
                            0.0F,
                            0.0625F,
                            new ResourceLocation("qwertech:textures/items/modeled/scythe.png"),
                            0,
                            0,
                            -20,
                            -0.1F,
                        ...
                        if (before != null && before.getItem() != null && inUse > 0) {
                            if (before.getItem() == item.getItem()) {
                                renderModel(
                                    ...
                                    0.0F,
                                    0.0625F,
                                    new ResourceLocation("qwertech:textures/items/modeled/wrench.png"),
                                    0,
                                    0,
                                    -20,
                                    -0.1F,
                                ...
                                MinecraftForgeClient.getItemRenderer(before, type)
                                    .renderItem(type, before, data);
                            } else {
                                renderModel(
                                    wrenchRenderer,
                ...
                switch (type) {
                    ...
                    // case EQUIPPED_FIRST_PERSON:
                    {
                        renderModel(
                            ...
                            0.0F,
                            0.0625F,
                            new ResourceLocation("qwertech:textures/items/modeled/club.png"),
                            0,
                            0,
                            -20,
                            -0.1F,
