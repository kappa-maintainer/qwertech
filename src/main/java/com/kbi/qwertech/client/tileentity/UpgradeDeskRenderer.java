        ...
        if (tileEntity.slotHas(0)) {
            ...
            if (aItem instanceof MultiItemArmor) {
                ...
                if (tStats != null) {
                    ...
                    GL11.glTranslatef(
                        0,
                        isIt == 3 ? -0.66F : isIt == 2 ? -0.25F : isIt == 1 ? 0.33F : isIt == 0 ? 1.1F : 0,
                        0);

                    if (playerModel == null) {
                        playerModel = new EntityPlayerSP(
                    ...
                    ModelBiped modelbiped = net.minecraftforge.client.ForgeHooksClient
                        .getArmorModel(playerModel, aStack, isIt, null);
