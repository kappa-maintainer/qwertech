...
public class QT_Tool_Renderer implements IItemRenderer {
        ...
        for (int q = 0; q < inventory.length; q++) {
            if (inventory[q] != null) {
                if (OP.rockGt.contains(inventory[q])) {
                    ...
                    || (inventory[q]).getItem() == Items.egg
                    || (inventory[q]).getItem() == Items.slime_ball
                    || (inventory[q]).getItem() == IL.Mud_Ball.getItem()) {
                        returnable = inventory[q];
                        break;
                    } else {
        ...
        if (data[1] != null) {
            ...
            if (launchable != null) {
                if (OP.chunkGt.contains(launchable)) {
                    ...
                    typeData = 4;
                } else if (launchable.getItem() == IL.Mud_Ball.getItem()
                    && launchable.getItemDamage() == IL.Mud_Ball.get(1, (Object[]) null)
                        .getItemDamage()) {
                            typeData = 5;
                        } else
                    if (OreDictManager.isItemStackInstanceOf(launchable, "cropTomato")) {
                        typeData = 6;
                    }
                if (typeData <= 2) {
    ...
    public boolean handleRenderType(ItemStack item, ItemRenderType type) {
        ...
        } else if (item.getItemDamage() == 18 || item.getItemDamage() == 16
            || item.getItemDamage() == 14
            || item.getItemDamage() == 0
            || item.getItemDamage() == 12
            || item.getItemDamage() == 10
            || OreDictManager.isItemStackInstanceOf(item, "toolMace")
            || OreDictManager.isItemStackInstanceOf(item, "toolSlingshot")) {
                switch (type) {
                    case EQUIPPED:
                    case EQUIPPED_FIRST_PERSON: {
                        // System.out.println("WE HAVE THE THINGY");
    ...
    public void renderModel(ModelBaseTool model, ItemStack item, Entity entity, float f, float f1, float f2, float f3,
        float f4, float f5, ResourceLocation texture, int rotatex, int rotatey, int rotatez, float translatex,
            ...
            switch (type) {
                ...
                // case EQUIPPED_FIRST_PERSON:
                {
                    renderModel(
                        ...
                        0.0F,
                        0.0625F,
                        new ResourceLocation("qwertech:textures/items/modeled/knuckles.png"),
                        0,
                        0,
                        0,
                        0F,
            ...
            switch (type) {
                case EQUIPPED: {
                    renderModel(
                        ...
                        0.0F,
                        0.0625F,
                        new ResourceLocation("qwertech:textures/items/modeled/doubleaxe.png"),
                        0,
                        0,
                        -20,
                        -0.1F,
            ...
            switch (type) {
                case EQUIPPED: {
                    renderModel(
                        ...
                        0.0F,
                        0.0625F,
                        new ResourceLocation("qwertech:textures/items/modeled/pickaxe.png"),
                        0,
                        0,
                        -130,
                        0.8F,
            ...
            switch (type) {
                case EQUIPPED: {
                    renderModel(
                        ...
                        0.0F,
                        0.0625F,
                        new ResourceLocation("qwertech:textures/items/modeled/shovel.png"),
                        0,
                        0,
                        -130,
                        0.8F,
            ...
            switch (type) {
                case EQUIPPED: {
                    renderModel(
                        ...
                        0.0F,
                        0.0625F,
                        new ResourceLocation("qwertech:textures/items/modeled/stake.png"),
                        0,
                        0,
                        -130,
                        0.8F,
            ...
            switch (type) {
                case EQUIPPED: {
                    renderModel(
                        ...
                        0.0F,
                        0.0625F,
                        new ResourceLocation("qwertech:textures/items/modeled/bat.png"),
                        0,
                        0,
                        -130,
                        0.8F,
            ...
            switch (type) {
                ...
                // case EQUIPPED_FIRST_PERSON:
                {
                    renderModel(
                        ...
                        0.0F,
                        0.0625F,
                        new ResourceLocation("qwertech:textures/items/modeled/mace.png"),
                        0,
                        0,
                        0,
                        0F,
            ...
            switch (type) {
                ...
                // case EQUIPPED_FIRST_PERSON:
                {
                    ...
                    Minecraft.getMinecraft().renderEngine
                        .bindTexture(new ResourceLocation("qwertech:textures/items/modeled/slingshot.png"));
