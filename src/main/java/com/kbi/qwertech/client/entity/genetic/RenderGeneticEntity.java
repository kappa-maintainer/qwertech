...
public class RenderGeneticEntity extends RenderLiving {
    ...
    public void doRender(IGeneticMob p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
    ...
    protected ResourceLocation getEntityTexture(IGeneticMob mob) {
        return new ResourceLocation(
            (String) MobSpeciesRegistry.getSpecies(mob.getClass(), (short) 0)
                .getSubtype((short) 0)
                .getTag(RegisterSpecies.TEXTURE_PRIMARY));
    }
