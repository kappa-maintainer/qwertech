...
public class ModelShuriken extends ModelBaseTool {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        GL11.glTranslatef(
            this.vertical.rotationPointX * f5,
            this.vertical.rotationPointY * f5,
            this.vertical.rotationPointZ * f5);
        ...
        GL11.glTranslatef(
            this.horizontal.rotationPointX * f5,
            this.horizontal.rotationPointY * f5,
            this.horizontal.rotationPointZ * f5);
