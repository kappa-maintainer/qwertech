...
public class ModelBaseTool extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5, int rotatex,
        int rotatey, int rotatez) {
        this.render(entity, f, f1, f2, f3, f4, f5, rotatex, rotatey, rotatez, 0, 0, 0);
    }

    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5,
        ResourceLocation texture, int rotatex, int rotatey, int rotatez) {
        Minecraft.getMinecraft().renderEngine.bindTexture(texture);
        this.render(entity, f, f1, f2, f3, f4, f5, rotatex, rotatey, rotatez, 0, 0, 0);
    }

    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5,
        ResourceLocation texture, int rotatex, int rotatey, int rotatez, float translatex, float translatey,
        float translatez) {
        Minecraft.getMinecraft().renderEngine.bindTexture(texture);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5, int rotatex,
        int rotatey, int rotatez, float translatex, float translatey, float translatez) {
