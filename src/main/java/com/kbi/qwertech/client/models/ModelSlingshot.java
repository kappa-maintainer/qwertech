...
public class ModelSlingshot extends ModelBase {
    ...
    public float[] defaultString = new float[] { 2.3F, 8.2F, 0.0F, 0.0F, 0.0F, -1.920F, -0.8F, 0.0F, -2.1F, 0.0F,
        0.436F, 0.0F, 3.0F, 10.0F, 0.0F, 0.0F, 0.0F, -0.349F };
    public float[] maximumString = new float[] { 2.3F, 6.6F, 0.0F, 0.0F, 0.0F, -1.571F, -1.2F, 0.0F, -1.7F, 0.0F,
        0.785F, 0.0F, 3.0F, 8.2F, 0.0F, 0.0F, 0.0F, 0.0F };
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
         ...
         * {
         * UT.Sounds.send(entity.worldObj, Block.soundTypeLadder.getStepResourcePath(), 0.5F, Math.max(0.5F, 2F - (72000
         * - f1)/100), (int)entity.posX, (int)entity.posY, (int)entity.posZ);
         * }
         */
        ...
        GL11.glTranslatef(
            this.String.rotationPointX * f5,
            this.String.rotationPointY * f5,
            this.String.rotationPointZ * f5);
        ...
        if (f1 > 0) {
            ...
            if (f <= 1) {
                ...
                GL11.glTranslatef(
                    this.rock.rotationPointX * f5,
                    this.rock.rotationPointY * f5,
                    this.rock.rotationPointZ * f5);
            ...
            if (f == 1) {
                ...
                GL11.glTranslatef(
                    this.rockOverlay.rotationPointX * f5,
                    this.rockOverlay.rotationPointY * f5,
                    this.rockOverlay.rotationPointZ * f5);
                ...
                Minecraft.getMinecraft().renderEngine
                    .bindTexture(new ResourceLocation("qwertech:textures/entity/rock/base.png"));
                // GL11.glTranslatef(this.rock.offsetX + this.rock.rotationPointX, this.rock.offsetY +
                // this.rock.rotationPointY, this.rock.offsetZ + this.rock.rotationPointZ);
                GL11.glTranslatef(this.rock.offsetX, this.rock.offsetY, this.rock.offsetZ);
                GL11.glTranslatef(
                    this.foilModel.rocky.rotationPointX * f5,
                    this.foilModel.rocky.rotationPointY * f5,
                    this.foilModel.rocky.rotationPointZ * f5);
                ...
                blue = (this.rockMaterial[2]) / 255.0F;
                GL11.glColor4f(
                    red + ((entity.ticksExisted % 60) / 600),
                    green + ((entity.ticksExisted % 50) / 500),
                    blue + ((entity.ticksExisted % 40) / 400),
                    1.0F);
                this.foilModel.rocky.render(f5);
                GL11.glColor4f(
                    red + ((entity.ticksExisted % 40) / 400),
                    green,
                    blue + ((entity.ticksExisted % 60) / 600),
                    1.0F);
                this.foilModel.rocky_1.render(f5);
                GL11.glColor4f(
                    red + ((entity.ticksExisted % 50) / 500),
                    green + ((entity.ticksExisted % 40) / 400),
                    blue,
                    1.0F);
                this.foilModel.rocky_2.render(f5);
                GL11.glColor4f(
                    red,
                    green + ((entity.ticksExisted % 60) / 600),
                    blue + ((entity.ticksExisted % 50) / 500),
                    1.0F);
                ...
                GL11.glPushMatrix();
                Minecraft.getMinecraft().renderEngine
                    .bindTexture(new ResourceLocation("qwertech:textures/entity/rock/ball.png"));
                GL11.glTranslatef(this.rock.offsetX, this.rock.offsetY, this.rock.offsetZ);
                GL11.glTranslatef(
                    this.ballModel.rocky.rotationPointX * f5,
                    this.ballModel.rocky.rotationPointY * f5,
                    this.ballModel.rocky.rotationPointZ * f5);
                ...
                GL11.glTranslatef(
                    ...
                    -this.ballModel.rocky.rotationPointZ * f5);
                GL11.glTranslatef(
                    (this.rock.rotationPointX * f5) + (2.5F * f5),
                    (this.rock.rotationPointY * f5) + (7.5F * f5),
                    (this.rock.rotationPointZ * f5));
    ...
    public void setStringPosition(float percent) {
        ...
        for (ModelRenderer mr : new ModelRenderer[] { this.rock, this.rockOverlay, this.foilModel.rocky,
            this.foilModel.rocky_1, this.foilModel.rocky_2, this.foilModel.rocky_3 }) {
