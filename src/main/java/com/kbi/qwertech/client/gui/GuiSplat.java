...
public class GuiSplat extends Gui {
    ...
    ResourceLocation[] splats = new ResourceLocation[] { new ResourceLocation("qwertech:textures/gui/splat1.png"),
        new ResourceLocation("qwertech:textures/gui/splat2.png"),
        new ResourceLocation("qwertech:textures/gui/splat3.png"),
        new ResourceLocation("qwertech:textures/gui/splat4.png") };
    ...
    public GuiSplat(Minecraft mc, int tickStart, int currentTick, short[] rgb) {
        ...
        mc.getTextureManager()
            .bindTexture(splats[adjuster.nextInt(4)]);
