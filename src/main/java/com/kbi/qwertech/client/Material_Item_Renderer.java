...
public class Material_Item_Renderer implements IItemRenderer {
    ...
    public void renderModel(ModelBaseTool model, ItemStack item, OreDictMaterial material, Entity entity, float f,
        float f1, float f2, float f3, float f4, float f5, ResourceLocation texture, int rotatex, int rotatey,
                ...
                switch (type) {
                    case EQUIPPED: {
                        renderModel(
                            ...
                            0.0F,
                            0.0625F,
                            new ResourceLocation("qwertech:textures/items/modeled/ingot.png"),
                            15,
                            0,
                            -155,
                            0.5F,
