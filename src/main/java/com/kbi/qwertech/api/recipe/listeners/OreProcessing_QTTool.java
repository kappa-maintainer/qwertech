...
public class OreProcessing_QTTool implements IOreDictListenerEvent {
    ...
    public void createHashMap(OreDictMaterial eventMaterial) {
        ...
        letterData
            .put('R', eventMaterial == MT.Stone ? ST.make(Blocks.stone, 1L, 32767L) : OP.stone.dat(eventMaterial));
    ...
    public void replaceData(Object[] recipeList, OreDictMaterial material) {
        ...
        for (int q = 0; q < recipeList.length; q++) {
            if (recipeList[q] instanceof ItemStack && ((ItemStack) recipeList[q]).getItem() instanceof MultiItemTool) {
                ...
                recipeList[q] = ((MultiItemTool) tool.getItem())
                    .getToolWithStats(tool.getItemDamage(), primary, secondary);
    ...
    public OreProcessing_QTTool(int aToolID, String aCategoryName, String[][] aToolRecipes, String[][] aToolHeadRecipes,
        HashMap<Character, Object> characterMap, ICondition aCondition) {
    ...
    public OreProcessing_QTTool(int aToolID, String aCategoryName, boolean aUseNormalHandle, boolean aDismantleable,
        long aCapacity, long aVoltage, OreDictMaterial aHandleOverride, String[][] aToolRecipes,
        String[][] aToolHeadRecipes, ICondition aCondition) {
        this.mSpecialObjectV = null;
        this.mSpecialObjectW = null;
        this.mSpecialObjectX = null;
        this.mSpecialObjectY = null;
    ...
    public OreProcessing_QTTool(int aToolID, String aCategoryName, boolean aUseNormalHandle, boolean aDismantleable,
        ...
        Object aSpecialObjectV, Object aSpecialObjectW, ICondition aCondition) {
            ...
            if (tCapacity < 0L) {
                ...
                if ((this.mSpecialObjectV instanceof IItemContainer)) {
                    ...
                    && ((((ItemStack) this.mSpecialObjectV).getItem() instanceof IItemEnergy))) {
                        tCapacity += ((IItemEnergy) ((ItemStack) this.mSpecialObjectV).getItem())
                            .getEnergyCapacity(TD.Energy.EU, (ItemStack) this.mSpecialObjectV);
                    }
                if ((this.mSpecialObjectW instanceof IItemContainer)) {
                    ...
                    && ((((ItemStack) this.mSpecialObjectW).getItem() instanceof IItemEnergy))) {
                        tCapacity += ((IItemEnergy) ((ItemStack) this.mSpecialObjectW).getItem())
                            .getEnergyCapacity(TD.Energy.EU, (ItemStack) this.mSpecialObjectW);
                    }
            }
            ItemStack tTool = ((MultiItemTool) QTI.qwerTool.getItem()).getToolWithStats(
                this.mToolID,
                1,
                aEvent.mMaterial,
                this.mHandleOverride == null ? aEvent.mMaterial
                    : this.mUseNormalHandle ? aEvent.mMaterial.mHandleMaterial : this.mHandleOverride,
                tCapacity,
                this.mVoltage);
            ItemStack tStack = aEvent.mPrefix.mat(aEvent.mMaterial, 1L);
            if (tTool != null) {
                createHashMap(aEvent.mMaterial);

                recObj = new Object[(letterData.size() * 2)];
                for (int q = 0; q < letterData.size(); q++) {
                    Character c = (Character) letterData.keySet()
                        .toArray()[q];
                    recObj[(q * 2)] = c;
                ...
                if ((this.mToolRecipes != null) && (this.mToolRecipes.length > 0)) {
                    for (int i = 0; i < this.mToolRecipes.length; i++) {
                        if ((this.mToolRecipes[i] != null) && (this.mToolRecipes[i].length > 0)
                            && ((this.mCategoryName == null) || (CS.ConfigsGT.RECIPES.get(
                                this.mCategoryName + ".toolrecipes." + i,
                ...
                if ((this.mToolHeadRecipes != null) && (this.mToolHeadRecipes.length > 0)) {
                    for (int i = 0; i < this.mToolHeadRecipes.length; i++) {
                        if ((this.mToolHeadRecipes[i] != null) && (this.mToolHeadRecipes[i].length > 0)
                            && ((this.mCategoryName == null) || (CS.ConfigsGT.RECIPES.get(
                                this.mCategoryName + ".toolheadrecipe." + i,
                                aEvent.mMaterial.mNameInternal,
                                true)))) {
                            Object[] recipeStrings = new Object[this.mToolHeadRecipes[i].length];
                            System.arraycopy(
                                this.mToolHeadRecipes[i],
                                0,
                                recipeStrings,
                                0,
                                this.mToolHeadRecipes[i].length);
                            Object[] result = Arrays.copyOf(recipeStrings, recObj.length + recipeStrings.length);
                            System.arraycopy(recObj, 0, result, recipeStrings.length, recObj.length);
