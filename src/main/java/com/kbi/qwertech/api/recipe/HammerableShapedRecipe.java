...
public class HammerableShapedRecipe implements IRecipe, ICraftingRecipeGT {
    ...
    public HammerableShapedRecipe(OreDictPrefix output, Object... items) {
        this(output, 1, MT.NULL, ICondition.TRUE, items);
    }

    public HammerableShapedRecipe(OreDictPrefix output, ICondition condition, Object... items) {
        this(output, 1, MT.NULL, condition, items);
    }

    public HammerableShapedRecipe(OreDictPrefix output, OreDictMaterial material, Object... items) {
        this(output, 1, material, ICondition.TRUE, items);
    }

    public HammerableShapedRecipe(OreDictPrefix output, OreDictMaterial material, ICondition condition,
        Object... items) {
        this(output, 1, material, condition, items);
    }

    public HammerableShapedRecipe(OreDictPrefix output, int amount, ICondition condition, Object... items) {
        this(output, amount, MT.NULL, condition, items);
    }

    public HammerableShapedRecipe(OreDictPrefix output, int amount, Object... items) {
        this(output, amount, MT.NULL, ICondition.TRUE, items);
    }

    public HammerableShapedRecipe(OreDictPrefix output, int amount, OreDictMaterial material, Object... items) {
        this(output, amount, material, ICondition.TRUE, items);
    }

    public HammerableShapedRecipe(OreDictPrefix output, int amount, OreDictMaterial material, ICondition condition,
        Object[] recipe) {
