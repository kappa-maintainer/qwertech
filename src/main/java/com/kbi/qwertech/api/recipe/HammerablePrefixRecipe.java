...
public class HammerablePrefixRecipe implements ICraftingRecipeGT, IRecipe {
    ...
    public HammerablePrefixRecipe(OreDictPrefix output, ICondition condition, OreDictPrefix input, Object... items) {
        this(output, 1, MT.NULL, condition, combineThings(new Object[] { input }, MT.NULL, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, OreDictPrefix input, Object... items) {
        this(output, 1, MT.NULL, ICondition.TRUE, combineThings(new Object[] { input }, MT.NULL, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, OreDictMaterial material, OreDictPrefix input,
        Object... items) {
        this(output, 1, material, ICondition.TRUE, combineThings(new Object[] { input }, material, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, OreDictMaterial material, ICondition condition,
        OreDictPrefix input, Object... items) {
        this(output, 1, material, condition, combineThings(new Object[] { input }, material, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, int amount, ICondition condition, OreDictPrefix input,
        Object... items) {
        this(output, amount, MT.NULL, condition, combineThings(new Object[] { input }, MT.NULL, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, int amount, OreDictPrefix input, Object... items) {
        this(output, amount, MT.NULL, ICondition.TRUE, combineThings(new Object[] { input }, MT.NULL, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, int amount, OreDictMaterial material, OreDictPrefix input,
        Object... items) {
        this(output, amount, material, ICondition.TRUE, combineThings(new Object[] { input }, material, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, int amount, OreDictMaterial material, ICondition condition,
        OreDictPrefix input, Object... items) {
        this(output, amount, material, condition, combineThings(new Object[] { input }, material, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, ICondition condition, Object[] primaryMats, Object... items) {
        this(output, 1, MT.NULL, condition, combineThings(primaryMats, MT.NULL, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, Object[] primaryMats, Object... items) {
        this(output, 1, MT.NULL, ICondition.TRUE, combineThings(primaryMats, MT.NULL, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, OreDictMaterial material, Object[] primaryMats,
        Object... items) {
        this(output, 1, material, ICondition.TRUE, combineThings(primaryMats, material, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, OreDictMaterial material, ICondition condition,
        Object[] primaryMats, Object... items) {
        this(output, 1, material, condition, combineThings(primaryMats, material, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, int amount, ICondition condition, Object[] primaryMats,
        Object... items) {
        this(output, amount, MT.NULL, condition, combineThings(primaryMats, MT.NULL, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, int amount, Object[] primaryMats, Object... items) {
        this(output, amount, MT.NULL, ICondition.TRUE, combineThings(primaryMats, MT.NULL, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, int amount, OreDictMaterial material, Object[] primaryMats,
        Object... items) {
        this(output, amount, material, ICondition.TRUE, combineThings(primaryMats, material, items));
    }

    public HammerablePrefixRecipe(OreDictPrefix output, int amount, OreDictMaterial material, ICondition condition,
        Object[] primaryMats, Object... items) {
        this(output, amount, material, condition, combineThings(primaryMats, material, items));
    }
        ...
        for (int i = 0; i < aGrid.getSizeInventory(); i++) {
            ...
            if (ST.valid(tStack)) {
                ...
                if (this.isHorizontal && this.tempHeight == -1) {
                    ...
                    && (int) Math.floor((i) / Math.sqrt(aGrid.getSizeInventory())) != this.tempHeight) {
                        return false;
                    }
    ...
    public ItemStack getCraftingResult(InventoryCrafting p_77572_1_) {
        ...
        return outputPrefix
            .mat(tempPrimary == null || tempPrimary == MT.NULL ? QTMT.Undefined : tempPrimary, outputAmount);
    }
