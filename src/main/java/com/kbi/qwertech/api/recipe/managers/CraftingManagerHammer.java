...
public class CraftingManagerHammer implements Runnable {
                        ...
                        if (ST.equal(key, theSlot)) {
                            if (items instanceof ItemStack[]) {
                                ...
                                for (int y = 0; y < sr.recipeHeight; y++) {
                                    inputs[y] = (sr.recipeWidth == 1 ? "X"
                                        : sr.recipeWidth == 2 ? "XX" : sr.recipeWidth == 3 ? "XXX" : "");
                                }
    ...
    public static void searchAndReplace() {
        if (QTConfigs.allHammers && !hasRun) {
            List oldRecipes = CraftingManager.getInstance()
                .getRecipeList();
            ...
            System.out.println(
                "Parsing complete, found " + count
                    + " hammer recipes and made "
                    + shapeless
                    + " shapeless recipes oredict friendly");
        } else {
            if (QTConfigs.anyHammers) {
                String tCategory = ConfigCategories.Recipes.gregtechrecipes + ".";
                // OP.ingotDouble.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory +
                // "ingots2ingotDouble", new String[][]{{"h", "I", "I"}}, null, null, null, null, null, new
                // ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE)));
                // OP.ingotTriple.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory +
                // "ingots2ingotTriple", new String[][]{{"h", "I", "X"}}, OP.ingotDouble, null, null, null, null, new
                // ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE)));
                // OP.ingotQuadruple.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory +
                // "ingots2ingotQuadruple", new String[][]{{"h", "I", "X"}}, OP.ingotTriple, null, null, null, null, new
                // ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE)));
                // OP.ingotQuintuple.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory +
                // "ingots2ingotQuintuple", new String[][]{{"h", "I", "X"}}, OP.ingotQuadruple, null, null,null, null,
                // new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE)));
                // OP.plateTiny.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory +
                // "chunkGt2plateTiny", new String[][]{{"h", "X"}}, OP.chunkGt, null, null, null, null, new
                // ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE)));
                // OP.plate.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory +
                // "plateCurved2plate", new String[][]{{"h", "X"}}, OP.plateCurved, null, null, null, null, new
                // ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE)));
                // OP.plate.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory + "ingots2plate",
                // new String[][]{{"h", "X"}}, OP.ingotDouble, null, null, null, null, new
                // ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE)));
                // OP.plateDouble.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory +
                // "ingots2plateDouble", new String[][]{{"h", "X"}}, OP.ingotTriple, null, null, null, null, new
                // ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE)));
                // OP.plateTriple.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory +
                // "ingots2plateTriple", new String[][]{{"h", "X"}}, OP.ingotQuadruple, null, null, null, null, new
                // ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE)));
                // OP.plateQuadruple.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory +
                // "ingots2plateQuadruple", new String[][]{{"h", "X"}}, OP.ingotQuintuple, null, null, null, null, new
                // ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE)));
                // OP.plateDouble.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory +
                // "ingots2plateDouble", new String[][]{{"h", "P", "P"}}, null, null, null, null, null, new
                // ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE)));
                // OP.plateTriple.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory +
                // "plates2plateTriple", new String[][]{{"h", "P", "X"}}, OP.plateDouble, null, null, null, null, new
                // ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE)));
                // OP.plateQuadruple.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory +
                // "plates2plateQuadruple", new String[][]{{"h", "P", "X"}}, OP.plateTriple, null, null, null, null, new
                // ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE)));
                // OP.plateQuintuple.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory +
                // "plates2plateQuintuple", new String[][]{{"h", "P", "X"}}, OP.plateQuadruple, null, null, null, null,
                // new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE)));
                // OP.plateCurved.addListener(new Loader_OreProcessing.OreProcessing_CraftFrom(1L, tCategory +
                // "plate2plateCurved", new String[][]{{"h", "P", "z"}}, null, null, null, null, null, new
                // ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE)));
                OP.ring.addListener(
                    new Loader_OreProcessing.OreProcessing_CraftFrom(
                        1L,
                        tCategory + "stick2ring",
                        new String[][] { { "hS", " o" } },
                        null,
                        null,
                        null,
                        null,
                        null,
                        new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE)));
                OP.spring.addListener(
                    new Loader_OreProcessing.OreProcessing_CraftFrom(
                        1L,
                        tCategory + "stick2spring",
                        new String[][] { { "zXh" } },
                        OP.stickLong,
                        null,
                        null,
                        ...
                        null,
                        new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE)));
                OP.springSmall.addListener(
                    new Loader_OreProcessing.OreProcessing_CraftFrom(
                        1L,
                        tCategory + "wire2springSmall",
                        new String[][] { { "oXh" } },
                        OP.wireGt01,
                        null,
                        null,
                ...
                OP.foil.addListener(
                    new Loader_OreProcessing.OreProcessing_CraftFrom(
                        ...
                        null,
                        new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE)));
                OP.casingSmall.addListener(
                    new Loader_OreProcessing.OreProcessing_CraftFrom(
                        1L,
                        tCategory + "plate2casingSmall",
                        new String[][] { { "h P" } },
                        null,
                        null,
                        null,
                        ...
                        new ICondition.And(
                            ...
                            TD.Compounds.COATED.NOT,
                            TD.Processing.SMITHABLE)));
                OP.stickLong.addListener(
                    new Loader_OreProcessing.OreProcessing_CraftFrom(
                        1L,
                        tCategory + "sticks2stickLong",
                        new String[][] { { "ShS" } },
                        null,
                        null,
                        null,
                ...
                OP.rotor.addListener(
                    new Loader_OreProcessing.OreProcessing_CraftFrom(
                        ...
                        new ICondition.And(
                            ...
                            TD.Compounds.COATED.NOT,
                            TD.Processing.SMITHABLE)));
                OP.toolHeadBuzzSaw.addListener(
                    new Loader_OreProcessing.OreProcessing_CraftFrom(
                        1L,
                        ...
                        null,
                        null,
                        new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT)));
                OP.toolHeadBuzzSaw.addListener(
                    new Loader_OreProcessing.OreProcessing_CraftFrom(
                        1L,
                        tCategory + "toolHeadBuzzSaw",
    ...
    private CraftingManagerHammer() {
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.ingotDouble,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.ingot, OP.ingot }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.ingotTriple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.ingot, OP.ingot, OP.ingot }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.ingotTriple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.ingotDouble, OP.ingot }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.ingotQuadruple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.ingotTriple, OP.ingot }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.ingotQuadruple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.ingotDouble, OP.ingot, OP.ingot }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.ingotQuadruple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.ingotDouble, OP.ingotDouble }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.ingotQuintuple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.ingotTriple, OP.ingotDouble }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.ingotQuintuple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.ingotTriple, OP.ingot, OP.ingot }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.ingotQuintuple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.ingotQuadruple, OP.ingot }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.ingotQuintuple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.ingotDouble, OP.ingotDouble, OP.ingot }).setVertical());

        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plate,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.ingotDouble }));
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plateDouble,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.ingotTriple }));
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plateTriple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.ingotQuadruple }));
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plateQuadruple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.ingotQuintuple }));

        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plateDouble,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.plate, OP.plate }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plateTriple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.plate, OP.plate, OP.plate }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plateTriple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.plateDouble, OP.plate }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plateQuadruple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.plateTriple, OP.plate }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plateQuadruple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.plateDouble, OP.plate, OP.plate }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plateQuadruple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.plateDouble, OP.plateDouble }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plateQuintuple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.plateTriple, OP.plateDouble }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plateQuintuple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.plateTriple, OP.plate, OP.plate }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plateQuintuple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.plateQuadruple, OP.plate }).setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plateQuintuple,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Compounds.COATED.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.plateDouble, OP.plateDouble, OP.plate }).setVertical());

        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plate,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.plateCurved }));
        // this.addRecipe(new HammerablePrefixRecipe(OP.foil, new ICondition.And(TD.Atomic.ANTIMATTER.NOT,
        // TD.Processing.SMITHABLE), new Object[]{OP.plate}, "craftingToolBendingCylinder").setHorizontal());
        // this.addRecipe(new HammerablePrefixRecipe(OP.plateCurved, new ICondition.And(TD.Atomic.ANTIMATTER.NOT,
        // TD.Processing.SMITHABLE), new Object[]{OP.plate}, "craftingToolBendingCylinder").setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.ring,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.stick },
                "craftingToolBendingCylinderSmall").setVertical());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.spring,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.stickLong },
                "craftingToolBendingCylinder").setHorizontal());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.springSmall,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.wireGt01 },
                "craftingToolBendingCylinderSmall").setHorizontal());
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.springSmall,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE),
        ...
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.plateTiny,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.nugget }));
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.stickLong,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.stick, OP.stick }));

        this.addRecipe(
            new HammerableShapedRecipe(
                OP.foil,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE),
                new String[] { "Pb" },
                'P',
        ...
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.gemExquisite,
                2,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT),
                new Object[] { OP.gemLegendary }));
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.gemFlawless,
                2,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT),
                new Object[] { OP.gemExquisite }));
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.gem,
                2,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT),
                new Object[] { OP.gemFlawless }));
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.gemFlawed,
                2,
        ...
        this.addRecipe(
            new HammerablePrefixRecipe(
                ...
                2,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT),
                new Object[] { OP.gemFlawed }));
        this.addRecipe(
            new HammerablePrefixRecipe(
                OP.dustSmall,
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT),
                new Object[] { OP.gemChipped }));

        // this.addRecipe(new HammerablePrefixRecipe(OreDictPrefix.get("link"),new
        // ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE), new Object[]{OP.ring} ));
        this.addRecipe(
            new HammerablePrefixRecipe(
                OreDictPrefix.get("chain"),
                new ICondition.And(TD.Atomic.ANTIMATTER.NOT, TD.Processing.SMITHABLE),
                new Object[] { OP.stick, OP.stick, OP.stick, OP.stick },
