...
public class WOOD {
    ...
    public static final ModData NAT = new ModData("Natura", "Natura");
    ...
    Oak = makeWood(1, "Oak", "Oak", MD.MC, 180, 144, 90, 255),
        ...
        Rubber = copyWood(10, MT.WoodRubber), Maple = makeWood(11, "Maple", "Maple", MD.GT, 151, 26, 26, 255),
    ...
    public static OreDictMaterial makeWood(int ID, String oreName, String local, ModData originalMod, int red,
        int green, int blue, int alpha, String... identicalNames) {
        for (int q = 0; q < identicalNames.length; q++) {
            identicalNames[q] = "Wood" + identicalNames[q];
        }
        OreDictMaterial returnable = OreDictMaterial.createMaterial(-1, "Wood" + oreName, local)
            .steal(MT.Wood)
            .setOriginalMod(originalMod)
            .setRGBa(red, green, blue, alpha)
            .addIdenticalNames(identicalNames);
