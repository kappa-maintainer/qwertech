...
public interface IArmorStats {
     ...
     */
    boolean renderHelmetOverlay(ItemStack stack, EntityPlayer player, ScaledResolution resolution, float partialTicks,
     ...
     */
    boolean onAnimalDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
     ...
     * @param event  The LivingHurtEvent. If source or amount are changed, change event.source or event.ammount!
     */
    boolean onAnyDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);
     ...
     * @param event  The LivingHurtEvent. If source or amount are changed, change event.source or event.ammount!
     */
    boolean onDrowningDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);
     ...
     * @param event  The LivingHurtEvent. If source or amount are changed, change event.source or event.ammount!
     */
    boolean onExplosionDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);
     ...
     * @param event  The LivingHurtEvent. If source or amount are changed, change event.source or event.ammount!
     */
    boolean onFallingDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);
     ...
     * @param event  The LivingHurtEvent. If source or amount are changed, change event.source or event.ammount!
     */
    boolean onFireDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);
     ...
     * @param event  The LivingHurtEvent. If source or amount are changed, change event.source or event.ammount!
     */
    boolean onHostileDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);
     ...
     * @param event  The LivingHurtEvent. If source or amount are changed, change event.source or event.ammount!
     */
    boolean onHungerDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);
     ...
     * @param event  The LivingHurtEvent. If source or amount are changed, change event.source or event.ammount!
     */
    boolean onLavaDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);
     ...
     * @param event  The LivingHurtEvent. If source or amount are changed, change event.source or event.ammount!
     */
    boolean onMagicDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);
     ...
     * @param event  The LivingHurtEvent. If source or amount are changed, change event.source or event.ammount!
     */
    boolean onPlayerDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);
     ...
     * @param event  The LivingHurtEvent. If source or amount are changed, change event.source or event.ammount!
     */
    boolean onProjectileDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);
     ...
     * @param event  The LivingHurtEvent. If source or amount are changed, change event.source or event.ammount!
     */
    boolean onWitherDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);
    ...
    ModelBiped getArmorModel(ItemStack stack, EntityLivingBase entity, int slot);

    void onHeatDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);

    void onFrostDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);

    void onChemDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);

    void onBumbleDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);

    void onSpikeDamage(World world, EntityLivingBase entity, ItemStack stack, DamageSource source, float amount,
        LivingHurtEvent event);
     ...
     * @return
     */
    boolean onClickedWearing(ItemStack armorStack, int slot, World world, EntityPlayer player,
