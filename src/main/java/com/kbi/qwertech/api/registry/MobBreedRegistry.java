...
public class MobBreedRegistry {
    ...
    public static boolean isBreedingItem(EntityAnimal entity, ItemStack stack) {
        ...
        ItemStack[] defaults = new ItemStack[] { ST.make(Items.wheat, 1, 0), ST.make(Items.wheat_seeds, 1, 0),
            ST.make(Items.carrot, 1, 0), ST.make(Items.fish, 1, 0), ST.make(Items.porkchop, 1, 0) };
