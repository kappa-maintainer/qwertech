...
public class RegisterMobs {
    ...
    private static void addSkeletonTools() {
        ...
        MobGearRegistry
            .registerTool("skeleton", GT_Tool.getToolWithStats(58, MT.BlueSteel, MT.BlueSteel.mHandleMaterial), 5, 3);
        MobGearRegistry
            .registerTool("skeleton", GT_Tool.getToolWithStats(40, MT.Adamantite, MT.Adamantite.mHandleMaterial), 1, 3);
    }
    ...
    private static void addZombieTools() {
        ...
        if (QTConfigs.enableTools) {
            ...
            MobGearRegistry.registerTool("zombie", QT_Tool.getToolWithStats(14, MT.Bronze, MT.Wood), 1, 4); // bronze
                                                                                                            // axe
            ...
            MobGearRegistry.registerTool("zombie", QT_Tool.getToolWithStats(12, MT.Steel, MT.Steel), 2, 2); // steel
                                                                                                            // spiked
                                                                                                            // bat

            MobGearRegistry.registerTool(
                "zombie",
                QT_Tool.getToolWithStats(6, MT.TungstenSteel, MT.TungstenSteel.mHandleMaterial),
                5,
                3);
            MobGearRegistry
                .registerTool("zombie", QT_Tool.getToolWithStats(6, MT.BlueSteel, MT.BlueSteel.mHandleMaterial), 5, 3);
            MobGearRegistry.registerTool(
                "zombie",
                QT_Tool.getToolWithStats(6, MT.DamascusSteel, MT.DamascusSteel.mHandleMaterial),
                5,
                3);
        ...
        MobGearRegistry.registerTool(
            "zombie",
            GT_Tool.getToolWithStats(58, MT.TungstenSteel, MT.TungstenSteel.mHandleMaterial),
            5,
            3);
        MobGearRegistry
            .registerTool("zombie", GT_Tool.getToolWithStats(58, MT.BlueSteel, MT.BlueSteel.mHandleMaterial), 5, 3);
        MobGearRegistry.registerTool(
            "zombie",
            GT_Tool.getToolWithStats(58, MT.DamascusSteel, MT.DamascusSteel.mHandleMaterial),
            5,
            3);
        MobGearRegistry.registerTool(
            "zombie",
            GT_Tool.getToolWithStats(36, MT.TungstenSteel, MT.TungstenSteel.mHandleMaterial),
            5,
            3);
        MobGearRegistry
            .registerTool("zombie", GT_Tool.getToolWithStats(36, MT.BlueSteel, MT.BlueSteel.mHandleMaterial), 5, 3);
        MobGearRegistry.registerTool(
            "zombie",
            GT_Tool.getToolWithStats(36, MT.DamascusSteel, MT.DamascusSteel.mHandleMaterial),
            5,
            3);
    }
    ...
    public void onInteracted(EntityInteractEvent event) {
        ...
        if (bottle != null && Item.getIdFromItem(bottle.getItem()) == Item.getIdFromItem(Items.glass_bottle)) {
            ...
            if (entityClass.equals(EntityChicken.class)) {
                ...
                if (entityClass.equals(EntityMagmaCube.class) && ((EntityMagmaCube) event.target).getSlimeSize() == 1) {
                ...
                } else if (entityClass.getName()
                    .equals("twilightforest.entity.passive.EntityTFBunny")) {
                        newBottle = QTI.jarTFBunny.get(1);
                    } else if (entityClass.getName()
                        .equals("twilightforest.entity.passive.EntityTFBird")) {
                            newBottle = QTI.jarTFBird.get(1);
                        } else if (entityClass.getName()
                            .equals("twilightforest.entity.EntityTFSwarmSpider")) {
                                newBottle = QTI.jarTFSpider.get(1);
                            } else if (entityClass.getName()
                                .equals("twilightforest.entity.passive.EntityTFSquirrel")) {
                                    newBottle = QTI.jarTFSquirrel.get(1);
                                } else if (entityClass.getName()
                                    .equals("twilightforest.entity.passive.EntityTFRaven")) {
                                        newBottle = QTI.jarTFRaven.get(1);
                                    } else if (entityClass.getName()
                                        .equals("twilightforest.entity.passive.EntityTFTinyBird")) {
                                            newBottle = QTI.jarTFTinyBird.get(1);
                                        } else if (entityClass.getName()
                                            .equals("twilightforest.entity.EntityTFMazeSlime")
                                            && ((EntitySlime) event.target).getSlimeSize() == 1) {
        ...
        for (int q = 0; q < event.drops.size(); q++) {
            ...
            if (event.source.getEntity() instanceof EntityLivingBase) {
                if (ST.equal(
                    ...
                    CS.ToolsGT.sMetaTool.getToolWithStats(36, MT.NULL, MT.NULL),
                    true)) {
                    if (is.getItem() == QTI.qwerFood.getItem()) {
                        switch (is.getItemDamage()) {
                            case 23: {
                                drop.setEntityItemStack(
                                    ST.make(QTI.qwerFood.getItem(), 1 + CS.RANDOM.nextInt(2 + event.lootingLevel), 5));
                                event.drops.add(
                                    new EntityItem(
                                        drop.worldObj,
                                        drop.posX,
                                        drop.posY,
                                        drop.posZ,
                                        ST.make(QTI.qwerFood.getItem(), 1 + CS.RANDOM.nextInt(2), 11)));
                                event.drops.add(
                                    new EntityItem(
                                        drop.worldObj,
                                        drop.posX,
                                        drop.posY,
                                        drop.posZ,
                                        ST.make(QTI.qwerFood.getItem(), 1 + CS.RANDOM.nextInt(2), 7)));
                                break;
                            }
                            case 24: {
                                drop.setEntityItemStack(
                                    ST.make(QTI.qwerFood.getItem(), 1 + CS.RANDOM.nextInt(2 + event.lootingLevel), 6));
                                event.drops.add(
                                    new EntityItem(
                                        drop.worldObj,
                                        drop.posX,
                                        drop.posY,
                                        drop.posZ,
                                        ST.make(QTI.qwerFood.getItem(), 1 + CS.RANDOM.nextInt(2), 12)));
                                event.drops.add(
                                    new EntityItem(
                                        drop.worldObj,
                                        drop.posX,
                                        drop.posY,
                                        drop.posZ,
                                        ST.make(QTI.qwerFood.getItem(), 1 + CS.RANDOM.nextInt(2), 8)));
                                break;
                            }
                            case 27: {
                                drop.setEntityItemStack(
                                    ST.make(QTI.qwerFood.getItem(), 1 + CS.RANDOM.nextInt(2 + event.lootingLevel), 25));
                                event.drops.add(
                                    new EntityItem(
                                        drop.worldObj,
                                        drop.posX,
                                        drop.posY,
                                        drop.posZ,
                                        ST.make(QTI.qwerFood.getItem(), 1 + CS.RANDOM.nextInt(2), 9)));
                                event.drops.add(
                                    new EntityItem(
                                        drop.worldObj,
                                        drop.posX,
                                        drop.posY,
                                        drop.posZ,
                                        ST.make(QTI.qwerFood.getItem(), 1 + CS.RANDOM.nextInt(2), 16)));
                                break;
                            }
                            case 28: {
                                drop.setEntityItemStack(
                                    ST.make(QTI.qwerFood.getItem(), 1 + CS.RANDOM.nextInt(2 + event.lootingLevel), 26));
                                event.drops.add(
                                    new EntityItem(
                                        drop.worldObj,
                                        drop.posX,
                                        drop.posY,
                                        drop.posZ,
                                        ST.make(QTI.qwerFood.getItem(), 1 + CS.RANDOM.nextInt(2), 10)));
                                event.drops.add(
                                    new EntityItem(
                                        drop.worldObj,
                                        drop.posX,
                                        drop.posY,
                                        drop.posZ,
                                        ST.make(QTI.qwerFood.getItem(), 1 + CS.RANDOM.nextInt(2), 17)));
                                break;
                            }
                            default:
                                break;
    ...
    public void onAdded(EntityJoinWorldEvent event) {
        ...
        if (event.entity instanceof EntityLiving && QTConfigs.doMobsUseGear) {
            if (((EntityLiving) event.entity).getHeldItem() != null) {
                if (event.entity instanceof EntityZombie) {
                    if (((EntityLiving) event.entity).getHeldItem()
                        .getItem()
                        .equals(Items.iron_shovel)
                        || ((EntityLiving) event.entity).getHeldItem()
                            .getItem()
                            .equals(Items.iron_sword)) {
                        // System.out.println("Replacing vanilla zombie item");
                        onMobSpawn(
                            new LivingSpawnEvent(
        ...
        if (QTConfigs.addCustomAI) {
            if (event.entity instanceof EntityAnimal) {
                ...
                for (int q = 0; q < tasks.size(); q++) {
                    ...
                    if (action instanceof EntityAITempt) {
                        ...
                        addAI(
                            (EntityLiving) event.entity,
                            new EntityAITemptAdvanced(ec, 1D, shy),
                            tasks.get(q).priority,
                            false,
                            false);
                        addAI(
                            (EntityLiving) event.entity,
                            new EntityAIEatFoodOffTheGround(ec),
                            tasks.get(q).priority - 1,
                            false,
                            false);
            ...
            if (event.entity instanceof EntityZombie) {
                addAI(
                    (EntityLiving) event.entity,
                    new EntityAIUseCompass((EntityCreature) event.entity, false, false),
                    1,
                    true,
                    false);
                ...
                addAI(
                    (EntityLiving) event.entity,
                    new EntityAITemperatureLimit((EntityLivingBase) event.entity, 1.3F, 1),
                    10,
                    false,
                    true);
                ...
                addAI(
                    (EntityLiving) event.entity,
                    new EntityAITemperatureLimit((EntityLivingBase) event.entity, 0.2F, -1).setDamage(2),
                    10,
                    false,
                    true);
                ...
                addAI(
                    (EntityLiving) event.entity,
                    new EntityAITemperatureLimit((EntityLivingBase) event.entity, 0.5F, 1),
                    10,
                    false,
                    true);
                ...
                addAI(
                    (EntityLiving) event.entity,
                    new EntityAIHydrationLimit((EntityLivingBase) event.entity, 0.2F, -1),
                    10,
                    false,
                    true);
            }
    ...
    public void onMobSpawn(LivingSpawnEvent event) {
        ...
        // System.out.println("The local difficulty at " + event.x + ", " + event.y + ", " + event.z + " is " +
        // localDif);
            ...
            if (new Random().nextFloat() < gearRegistry.getChances(key)) {
                ...
                if (item != null) {
                    ...
                    if (item.getItem() instanceof MultiItemTool) {
                        if (MultiItemTool.getPrimaryMaterial(item) == MT.NULL
                            || MultiItemTool.getPrimaryMaterial(item) == MT.Empty) {
                            OreDictMaterial[] mats = getMaterials(item, item.getItemDamage());
                            item = ((MultiItemTool) item.getItem())
                                .getToolWithStats(item.getItemDamage(), mats[0], mats[1]);
                        }
    ...
    public void onLivingHurt(LivingHurtEvent event) {
        ...
        if (held != null && held.getItem() == QTI.qwerTool.getItem() && held.getItemDamage() == 20) {
            if (event.source.getEntity() instanceof EntityPlayer || event.source.getEntity() instanceof EntityZombie
        ...
        for (int q = 1; q < 5; q++) {
            ...
            if (armorPiece != null && armorPiece.getItem() instanceof MultiItemArmor) {
                ((MultiItemArmor) armorPiece.getItem()).onArmorHit(
