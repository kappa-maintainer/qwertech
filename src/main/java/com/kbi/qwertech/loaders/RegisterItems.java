        ...
        QTI.syringe.set(new MultiItemRandom(QwerTech.MODID, "qwertech.dna") {
            ...
            public void addItems() {
                ...
                addItem(
                    ...
                    "Purified droppity dripper",
                    UT.Fluids.make("ic2distilledwater", 100L));

                addItem(
                    10,
                    "Syringe of Saltwater",
                    "Non-potable",
                    UT.Fluids.make("saltwater", 100L),
                ...
                addItem(
                    11,
                    "Syringe of Salty Water",
                    "Non-potable",
                    UT.Fluids.make("seawater", 100L),
                    new FluidContainerRegistry.FluidContainerData(
                        UT.Fluids.make("seawater", 100L),
                        make(11),
                        make(0),
                        T),
                    new FluidContainerRegistry.FluidContainerData(UT.Fluids.make("water", 100L), make(11), make(2), T),
                    new FluidContainerRegistry.FluidContainerData(
                        UT.Fluids.make("ic2distilledwater", 100L),
                        make(11),
                        make(2),
                ...
                addItem(
                    20,
                    "Syringe of Apple Juice",
                    "WARNING: Keep away from medical professionals",
                    new FluidContainerData(UT.Fluids.make("binnie.juiceapple", 100L), make(20), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juiceapple", 100L), make(20), make(3), T));
                addItem(
                    21,
                    "Syringe of Beet Juice",
                    "Not THAT kind of healthy for you",
                    new FluidContainerData(UT.Fluids.make("beetjuice", 100L), make(21), make(0), T),
                    new FluidContainerData(UT.Fluids.make("beetjuice", 100L), make(21), make(3), T));
                addItem(
                    22,
                    "Syringe of Kiwi Juice",
                    "The fruit, not the bird... ew",
                    new FluidContainerData(UT.Fluids.make("kiwijuice", 100L), make(22), make(0), T),
                    new FluidContainerData(UT.Fluids.make("kiwijuice", 100L), make(22), make(3), T));
                addItem(
                    23,
                    "Syringe of Melon Juice",
                    "Not to be used for melon enhancement",
                    new FluidContainerData(UT.Fluids.make("melonjuice", 100L), make(23), make(0), T),
                    new FluidContainerData(UT.Fluids.make("melonjuice", 100L), make(23), make(3), T));
                addItem(
                    24,
                    "Syringe of Plum Juice",
                    "Prune juice isn't a thing",
                    new FluidContainerData(UT.Fluids.make("binnie.juiceplum", 100L), make(24), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juiceplum", 100L), make(24), make(3), T));
                addItem(
                    25,
                    "Syringe of Blackberry Juice",
                    "They prefer to be called African-Americanberries",
                    new FluidContainerData(UT.Fluids.make("blackberryjuice", 100L), make(25), make(0), T),
                    new FluidContainerData(UT.Fluids.make("blackberryjuice", 100L), make(25), make(3), T));
                addItem(
                    26,
                    "Syringe of Apricot Juice",
                    "APRICODABRA! ...Nothing happened.",
                    new FluidContainerData(UT.Fluids.make("binnie.juiceapricot", 100L), make(26), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juiceapricot", 100L), make(26), make(3), T));
                addItem(
                    27,
                    "Syringe of Carrot Juice",
                    "Bunny transfusion",
                    new FluidContainerData(UT.Fluids.make("binnie.juicecarrot", 100L), make(27), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juicecarrot", 100L), make(27), make(3), T));
                addItem(
                    28,
                    "Syringe of Red Grape Juice",
                    "Baby's First Wine",
                    new FluidContainerData(UT.Fluids.make("binnie.juiceredgrape", 100L), make(28), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juiceredgrape", 100L), make(28), make(3), T));
                addItem(
                    29,
                    "Syringe of Blood*",
                    "(actually Tomato Juice)",
                    new FluidContainerData(UT.Fluids.make("binnie.juicetomato", 100L), make(29), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juicetomato", 100L), make(29), make(3), T));
                addItem(
                    30,
                    "Syringe of Blood*",
                    "(actually Cherry Juice)",
                    new FluidContainerData(UT.Fluids.make("binnie.juicecherry", 100L), make(30), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juicecherry", 100L), make(30), make(3), T));
                addItem(
                    31,
                    "Syringe of Fig Juice",
                    "Figgin' useless",
                    new FluidContainerData(UT.Fluids.make("figjuice", 100L), make(31), make(0), T),
                    new FluidContainerData(UT.Fluids.make("figjuice", 100L), make(31), make(3), T));
                addItem(
                    32,
                    "Syringe of Pear Juice",
                    "Will not give you a pear shape",
                    new FluidContainerData(UT.Fluids.make("binnie.juicepear", 100L), make(32), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juicepear", 100L), make(32), make(3), T));
                addItem(
                    33,
                    "Syringe of Peach Juice",
                    "The 'ch' is important",
                    new FluidContainerData(UT.Fluids.make("binnie.juicepeach", 100L), make(33), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juicepeach", 100L), make(33), make(3), T));
                addItem(
                    34,
                    "Syringe of Blood*",
                    "(actually Strawberry Juice)",
                    new FluidContainerData(UT.Fluids.make("strawberryjuice", 100L), make(34), make(0), T),
                    new FluidContainerData(UT.Fluids.make("strawberryjuice", 100L), make(34), make(3), T));
                addItem(
                    35,
                    "Syringe of Pomegranate Juice",
                    "More useful than granite pom-poms",
                    new FluidContainerData(UT.Fluids.make("pomegranatejuice", 100L), make(35), make(0), T),
                    new FluidContainerData(UT.Fluids.make("pomegranatejuice", 100L), make(35), make(3), T));
                addItem(
                    36,
                    "Syringe of Juice",
                    "No, I don't know, it's just... juice",
                    new FluidContainerData(UT.Fluids.make("juice", 100L), make(36), make(0), T),
                    new FluidContainerData(UT.Fluids.make("juice", 100L), make(36), make(3), T));
                addItem(
                    37,
                    "Syringe of Lemon Juice",
                    "Concentrated sour",
                    new FluidContainerData(UT.Fluids.make("binnie.juicelemon", 100L), make(37), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juicelemon", 100L), make(37), make(3), T));
                addItem(
                    38,
                    "Syringe of Lime Juice",
                    "It's like lemon juice, but green, because green is cooler",
                    new FluidContainerData(UT.Fluids.make("binnie.juicelime", 100L), make(38), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juicelime", 100L), make(38), make(3), T));
                addItem(
                    39,
                    "Syringe of Papaya Juice",
                    "No, I didn't say pie juice",
                    new FluidContainerData(UT.Fluids.make("papayajuice", 100L), make(39), make(0), T),
                    new FluidContainerData(UT.Fluids.make("papayajuice", 100L), make(39), make(3), T));
                addItem(
                    40,
                    "Syringe of Currant Juice",
                    "The most up-to-date juice there is",
                    new FluidContainerData(UT.Fluids.make("currantjuice", 100L), make(40), make(0), T),
                    new FluidContainerData(UT.Fluids.make("currantjuice", 100L), make(40), make(3), T));
                addItem(
                    41,
                    "Syringe of Blueberry Juice",
                    "Be more careful with this than Willy",
                    new FluidContainerData(UT.Fluids.make("blueberryjuice", 100L), make(41), make(0), T),
                    new FluidContainerData(UT.Fluids.make("blueberryjuice", 100L), make(41), make(3), T));
                addItem(
                    42,
                    "Syringe of Potato Juice",
                    "Yes. Potato juice. Pure potato.",
                    new FluidContainerData(UT.Fluids.make("potatojuice", 100L), make(42), make(0), T),
                    new FluidContainerData(UT.Fluids.make("potatojuice", 100L), make(42), make(3), T));
                addItem(
                    43,
                    "Syringe of Olive Juice",
                    "Yes, it's a thing",
                    new FluidContainerData(UT.Fluids.make("binnie.juiceolive", 100L), make(43), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juiceolive", 100L), make(43), make(3), T));
                addItem(
                    44,
                    "Syringe of Blood*",
                    "(actually Cranberry Juice)",
                    new FluidContainerData(UT.Fluids.make("binnie.juicecranberry", 100L), make(44), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juicecranberry", 100L), make(44), make(3), T));
                addItem(
                    45,
                    "Syringe of White Grape Juice",
                    "The good kind",
                    new FluidContainerData(UT.Fluids.make("binnie.juicewhitegrape", 100L), make(45), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juicewhitegrape", 100L), make(45), make(3), T));
                addItem(
                    46,
                    "Syringe of Mango Juice",
                    "Go Juiceman",
                    new FluidContainerData(UT.Fluids.make("mangojuice", 100L), make(46), make(0), T),
                    new FluidContainerData(UT.Fluids.make("mangojuice", 100L), make(46), make(3), T));
                addItem(
                    47,
                    "Syringe of Banana Juice",
                    "I ain't no hollaback girl",
                    new FluidContainerData(UT.Fluids.make("binnie.juicebanana", 100L), make(47), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juicebanana", 100L), make(47), make(3), T));
                addItem(
                    48,
                    "Syringe of Grapefruit Juice",
                    "NOT to be confused with Grape fruit-juice",
                    new FluidContainerData(UT.Fluids.make("binnie.juicegrapefruit", 100L), make(48), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juicegrapefruit", 100L), make(48), make(3), T));
                addItem(
                    49,
                    "Syringe of Orange Juice",
                    "Actually more of a Yellow Juice",
                    new FluidContainerData(UT.Fluids.make("binnie.juiceorange", 100L), make(49), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juiceorange", 100L), make(49), make(3), T));
                addItem(
                    50,
                    "Syringe of Persimmon Juice",
                    "1 persimmon per simmon",
                    new FluidContainerData(UT.Fluids.make("persimmonjuice", 100L), make(50), make(0), T),
                    new FluidContainerData(UT.Fluids.make("persimmonjuice", 100L), make(50), make(3), T));
                addItem(
                    51,
                    "Syringe of Elderberry Juice",
                    "Will not help with age wrinkles",
                    new FluidContainerData(UT.Fluids.make("binnie.juiceelderberry", 100L), make(51), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juiceelderberry", 100L), make(51), make(3), T));
                addItem(
                    52,
                    "Syringe of Blood*",
                    "(actually Raspberry Juice)",
                    new FluidContainerData(UT.Fluids.make("raspberryjuice", 100L), make(52), make(0), T),
                    new FluidContainerData(UT.Fluids.make("raspberryjuice", 100L), make(52), make(3), T));
                addItem(
                    53,
                    "Syringe of Pumpkin Juice",
                    "Juice'o'Lantern",
                    new FluidContainerData(UT.Fluids.make("pumpkinjuice", 100L), make(53), make(0), T),
                    new FluidContainerData(UT.Fluids.make("pumpkinjuice", 100L), make(53), make(3), T));
                addItem(
                    54,
                    "Syringe of Gooseberry Juice",
                    "Has nothing to do with birds",
                    new FluidContainerData(UT.Fluids.make("gooseberryjuice", 100L), make(54), make(0), T),
                    new FluidContainerData(UT.Fluids.make("gooseberryjuice", 100L), make(54), make(3), T));
                addItem(
                    55,
                    "Syringe of Starfruit Juice",
                    "No, no... star juice is just Hydrogen",
                    new FluidContainerData(UT.Fluids.make("starfruitjuice", 100L), make(55), make(0), T),
                    new FluidContainerData(UT.Fluids.make("starfruitjuice", 100L), make(55), make(3), T));
                addItem(
                    56,
                    "Syringe of Pineapple Juice",
                    "Or Ananas Juice, if you are so inclined",
                    new FluidContainerData(UT.Fluids.make("binnie.juicepineapple", 100L), make(56), make(0), T),
                    new FluidContainerData(UT.Fluids.make("binnie.juicepineapple", 100L), make(56), make(3), T));
                addItem(
                    57,
                    "Syringe of Grape Juice",
                    "It's grrrrrrrape",
                    new FluidContainerData(UT.Fluids.make("grapejuice", 100L), make(57), make(0), T),
                    new FluidContainerData(UT.Fluids.make("grapejuice", 100L), make(57), make(3), T));
                addItem(
                    58,
                    "Syringe of Sugarwater",
                    "100cc of sugar helps the medicine flow down",
                    UT.Fluids.make("sugarwater", 100L),
                    new FluidContainerData(UT.Fluids.make("water", 100L), make(58), make(3), T),
                    new FluidContainerRegistry.FluidContainerData(
                        UT.Fluids.make("sugarwater", 100L),
                        make(58),
                        make(0),
                ...
                addItem(
                    100,
                    "Syringe of Dirty Water",
                    "Needs to be flushed a few times",
                    new FluidContainerData(UT.Fluids.make("waterdirty", 100L), make(100), make(1), T),
                    new FluidContainerRegistry.FluidContainerData(UT.Fluids.make("water", 100L), make(100), make(1), T),
                    new FluidContainerRegistry.FluidContainerData(
                        UT.Fluids.make("waterdirty", 100L),
                        make(100),
                        make(0),
                        T),
                    new FluidContainerRegistry.FluidContainerData(
                ...
                addItem(
                    101,
                    "Syringe of Milk",
                    "Not for infant injection",
                    UT.Fluids.make("milk", 100L),
                    new FluidContainerData(UT.Fluids.make("milk", 100L), make(101), make(0), T));
                addItem(
                    102,
                    "Syringe of Blood",
                    "",
                    UT.Fluids.make("blood", 100L),
                    new FluidContainerData(UT.Fluids.make("blood", 100L), make(102), make(0), T));
                addItem(
                    103,
                    "Syringe of DNA",
                    "",
                    UT.Fluids.make("dna", 100L),
                    new FluidContainerData(UT.Fluids.make("dna", 100L), make(103), make(0), T));
                addItem(
                    104,
                    "Syringe of Soymilk",
                    "Not actually milk",
                    UT.Fluids.make("soymilk", 100L),
                    new FluidContainerData(UT.Fluids.make("soymilk", 100L), make(104), make(0), T));
                addItem(
                    105,
                    "Syringe of Blaze",
                    "IT BURNS!",
                    UT.Fluids.make("blaze", 100L),
                    new FluidContainerData(UT.Fluids.make("blaze", 100L), make(105), make(0), T));
                addItem(
                    106,
                    "Syringe of Mushroom Soup",
                    "Delicious",
                    UT.Fluids.make("mushroomsoup", 100L),
                    new FluidContainerData(UT.Fluids.make("mushroomsoup", 100L), make(106), make(0), T));
                addItem(
                    107,
                    "Syringe of Ice Water",
                    "You said " + LH.Chat.ITALIC + "hypothermic" + LH.Chat.RESET + " needle, right?",
                    UT.Fluids.make("ice", 100L),
                    new FluidContainerData(UT.Fluids.make("ice", 100L), make(107), make(0), T));
                addItem(
                    108,
                    "Syringe of Slime",
                    "It's squirming around in there...",
                    UT.Fluids.make("slime", 100L),
                    new FluidContainerData(UT.Fluids.make("slime", 100L), make(108), make(0), T));

                CR.shaped(
                    make(2, 0),
                    new Object[] { "ABA", " C ", " D ", 'A', OP.round.dat(MT.Plastic)
                        .toString(), 'B',
                        OP.stick.dat(MT.Plastic)
                            .toString(),
                        'C', OP.pipeTiny.dat(MT.Plastic)
                            .toString(),
                        'D', OP.bolt.dat(ANY.Steel)
                            .toString() });
            }
            ...
            public int fill(ItemStack aStack, FluidStack aFluid, boolean doFill) {
                ...
                switch (dam) {
                    ...
                    case 2:
                    case 3:
                        if (aFluid.isFluidEqual(UT.Fluids.make("dna", 1))
                            || aFluid.isFluidEqual(UT.Fluids.make("blood", 1))) {
            ...
            public void addAdditionalToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
                ...
                if (nbt.getString("ClassName") != null && !nbt.getString("ClassName")
                    .equals("")) {
        ...
        QTI.qwerFood.set(new MultiItemRandomWithCompat(QwerTech.MODID, "qwertech.food") {
            ...
            public void addItems() {
                addItem(
                    ...
                    "Mozzarella",
                    "Itsa good cheese",
                    new FoodStat(3, 0.5F, 0F, 310F, 0.1F, EnumAction.eat, null, false, false, false, false));
                addItem(
                    1,
                    "Raw Parmesan",
                    "Needs to be soaked in saltwater",
                    new FoodStat(1, 0.1F, 0F, 310F, 0.1F, EnumAction.eat, null, false, false, false, false));
                addItem(
                    2,
                    "Parmesan",
                    "Ready for grating!",
                    new FoodStat(3, 0.5F, -10F, 310F, 0.1F, EnumAction.eat, null, false, false, false, false));
                addItem(
                    3,
                    "Grated Parmesan",
                    "Pasta perfection",
                ...
                FurnaceRecipes.smelting()
                    .func_151394_a(QTI.turkeyBreastRaw.get(1), QTI.turkeyBreastCooked.get(1), 1.0F);
                FurnaceRecipes.smelting()
                    .func_151394_a(QTI.turkeyLegRaw.get(1), QTI.turkeyLegCooked.get(1), 1.0F);
                FurnaceRecipes.smelting()
                    .func_151394_a(QTI.chickenWingRaw.get(1), QTI.chickenWingCooked.get(1), 1.0F);
                FurnaceRecipes.smelting()
                    .func_151394_a(QTI.turkeyWingRaw.get(1), QTI.turkeyWingCooked.get(1), 1.0F);
                FurnaceRecipes.smelting()
                    .func_151394_a(QTI.chickenLegRaw.get(1), QTI.chickenLegCooked.get(1), 1.0F);
                FurnaceRecipes.smelting()
                    .func_151394_a(QTI.turkeyWholeRaw.get(1), QTI.turkeyWholeCooked.get(1), 1.0F);
                FurnaceRecipes.smelting()
                    .func_151394_a(QTI.chickenBreastRaw.get(1), QTI.chickenBreastCooked.get(1), 1.0F);
                FurnaceRecipes.smelting()
                    .func_151394_a(QTI.chickenWholeRaw.get(1), QTI.chickenWholeCooked.get(1), 1.0F);
                FurnaceRecipes.smelting()
                    .func_151394_a(QTI.frogLegRaw.get(1), QTI.frogLegCooked.get(1), 1.0F);
                FurnaceRecipes.smelting()
                    .func_151394_a(QTI.junglefowlBreastRaw.get(1), QTI.junglefowlBreastCooked.get(1), 1.0F);
                FurnaceRecipes.smelting()
                    .func_151394_a(QTI.junglefowlLegRaw.get(1), QTI.junglefowlLegCooked.get(1), 1.0F);
                FurnaceRecipes.smelting()
                    .func_151394_a(QTI.junglefowlWholeRaw.get(1), QTI.junglefowlWholeCooked.get(1), 1.0F);
                FurnaceRecipes.smelting()
                    .func_151394_a(QTI.junglefowlWingRaw.get(1), QTI.junglefowlWingCooked.get(1), 1.0F);
                ...
                RM.Mixer.addRecipe1(
                    ...
                    16L,
                    32L,
                    OP.dustSmall.mat(MT.Cheese, 3),
                    UT.Fluids.make("milk", 1000),
                    null,
                    QTI.parmesanRaw.get(1));
                ...
                CR.shapeless(
                    ...
                    CR.DEF_NAC,
                    new Object[] { ST.make(this, 1, 1000), IL.Food_Dough_Flat });
                CR.shapeless(
                    QTI.doughFlatSauce.get(2),
                    CR.DEF_NAC,
                    new Object[] { ST.make(this, 1, 1000), IL.Food_Dough_Flat, IL.Food_Dough_Flat });
                CR.shapeless(
                    QTI.doughFlatSauce.get(3),
                    CR.DEF_NAC,
                    new Object[] { ST.make(this, 1, 1000), IL.Food_Dough_Flat, IL.Food_Dough_Flat,
                        IL.Food_Dough_Flat });
                CR.shapeless(
                    QTI.doughFlatSauce.get(4),
                    CR.DEF_NAC,
                    new Object[] { ST.make(this, 1, 1000), IL.Food_Dough_Flat, IL.Food_Dough_Flat, IL.Food_Dough_Flat,
                        IL.Food_Dough_Flat });
                CR.shapeless(
                ...
                CR.shapeless(
                    ...
                    CR.DEF,
                    new Object[] { QTI.doughFlatSauce, QTI.mozzarella, QTI.mozzarella, QTI.mozzarella });
                CR.shapeless(
                    IL.Food_Pizza_Meat_Raw.get(1),
                    CR.DEF,
                    new Object[] { QTI.doughFlatSauce, QTI.mozzarella, OP.dust.dat(MT.MeatCooked) });
                CR.shapeless(
                    IL.Food_Pizza_Meat_Raw.get(1),
                    CR.DEF,
                    new Object[] { QTI.doughFlatSauce, QTI.mozzarella, OP.scrap.dat(MT.MeatCooked) });
                CR.shapeless(
                    IL.Food_Pizza_Veggie_Raw.get(1),
                    CR.DEF,
                    new Object[] { QTI.doughFlatSauce, QTI.mozzarella, IL.Food_Cucumber_Sliced, IL.Food_Tomato_Sliced,
                        IL.Food_Onion_Sliced });
                CR.shapeless(
                    IL.Food_Pizza_Ananas_Raw.get(1),
                    CR.DEF,
                    new Object[] { QTI.doughFlatSauce, IL.Food_Ananas_Sliced, IL.Food_Ananas_Sliced,
                        IL.Food_Ham_Slice_Cooked, QTI.mozzarella });

                // cut chicken into legs and breasts
                CR.shapeless(
                    QTI.chickenLegRaw.get(2),
                    CR.DEF,
                    new Object[] { QTI.chickenWholeRaw, "craftingToolKnife" });
                CR.shapeless(
                    QTI.chickenLegCooked.get(2),
                    CR.DEF,
                    new Object[] { QTI.chickenWholeCooked, "craftingToolKnife" });
                CR.shapeless(QTI.turkeyLegRaw.get(2), CR.DEF, new Object[] { QTI.turkeyWholeRaw, "craftingToolKnife" });
                CR.shapeless(
                    QTI.turkeyLegCooked.get(2),
                    CR.DEF,
                    new Object[] { QTI.turkeyWholeCooked, "craftingToolKnife" });
                CR.shapeless(
                    QTI.junglefowlLegRaw.get(2),
                    CR.DEF,
                    new Object[] { QTI.junglefowlWholeRaw, "craftingToolKnife" });
                CR.shapeless(
                    QTI.junglefowlLegCooked.get(2),
                    CR.DEF,
                    new Object[] { QTI.junglefowlWholeCooked, "craftingToolKnife" });
                ...
                RM.Bath.addRecipe1(
                    ...
                    0L,
                    16L,
                    QTI.chickenLegRaw.get(1),
                    UT.Fluids.make("hotfryingoil", 10),
                    null,
                    QTI.chickenLegFried.get(1));
                RM.Bath.addRecipe1(
                    true,
                    0L,
                    16L,
                    QTI.chickenWingRaw.get(1),
                    UT.Fluids.make("hotfryingoil", 10),
                    null,
                    QTI.chickenWingFried.get(1));
                RM.Bath.addRecipe1(
                    true,
                    0L,
                    16L,
                    QTI.turkeyLegRaw.get(1),
                    UT.Fluids.make("hotfryingoil", 10),
                    null,
                    QTI.turkeyLegFried.get(1));
                RM.Bath.addRecipe1(
                    true,
                    0L,
                    16L,
                    QTI.turkeyWingRaw.get(1),
                    UT.Fluids.make("hotfryingoil", 10),
                    null,
                    QTI.turkeyWingFried.get(1));
                RM.Bath.addRecipe1(
                    true,
                    0L,
                    16L,
                    QTI.junglefowlLegRaw.get(1),
                    UT.Fluids.make("hotfryingoil", 10),
                    null,
                    QTI.junglefowlLegFried.get(1));
                RM.Bath.addRecipe1(
                    true,
                    0L,
                    16L,
                    QTI.junglefowlWingRaw.get(1),
                    UT.Fluids.make("hotfryingoil", 10),
                    null,
                    QTI.junglefowlLegFried.get(1));
                ...
                CR.shapeless(
                    ST.make(Items.writable_book, 1, 0),
                    CR.DEF,
                    new Object[] { ST.make(Items.book, 1, 0), "feather", "dyeBlack" });
            ...
            public void addAdditionalToolTips(List aList, ItemStack aStack, boolean aF3_H) {
                ...
                if (tag.hasKey("QTgenes")) {
                    if (tag.hasKey("Timer")) {
                        if (net.minecraft.client.Minecraft.getMinecraft().theWorld.getTotalWorldTime()
                            > tag.getLong("Timer")) {
                            aList.add("Ready to hatch!");
                        } else {
                            aList.add(
                                "Will hatch in " + (tag.getLong("Timer")
                                    - net.minecraft.client.Minecraft.getMinecraft().theWorld.getTotalWorldTime()));
                        }
                    } else {
            ...
            public boolean onEntityItemUpdate(EntityItem entityItem) {
                ...
                switch (entityItem.getEntityItem()
                    .getItemDamage()) {
                    case 31:
                        ...
                        if (nbt.hasKey("Timer")) {
                            if (entityItem.worldObj.getTotalWorldTime() > nbt.getLong("Timer")) {
                                if (nbt.hasKey("QTgenes")) {
                                    ...
                                    int maturity = nbt.getCompoundTag("QTgenes")
                                        .getShort("maturity") * -1;
        ...
        new MultiItemRandom(QwerTech.MODID, "qwertech.animals") {
            ...
            public void addItems() {
                ...
                addItem(
                    1005,
                    "Silverfish-in-a-Jar",
                    "Not good enough for the goldfish",
                    new Behavior_Spawn(EntitySilverfish.class));
                    ...
                    if (aStack.hasTagCompound()) {
                        ...
                        if (nbt.hasKey("QTgenes")) {
                            ...
                            if (genes.hasKey("species")) {
                                Species species = MobSpeciesRegistry
                                    .getSpecies(EntityPhasianidae.class, genes.getShort("species"));
        ...
        new MultiItemRandom(QwerTech.MODID, "qwertech.armor.upgrades") {
            ...
            public void addItems() {
                ...
                CR.shapeless(
                    ST.make(this, 1, 1),
                    CR.DEF,
                    new Object[] { "springSmallStainlessSteel", "springSmallStainlessSteel" });
                CR.shapeless(ST.make(this, 1, 2), CR.DEF, new Object[] { "springSmallBrass", "springSmallBrass" });
                CR.shapeless(
                    ST.make(this, 1, 3),
                    CR.DEF,
                    new Object[] { "springSmallAluminium", "springSmallAluminium" });
                CR.shapeless(
                    ST.make(this, 1, 4),
                    CR.DEF,
                    new Object[] { "springSmallThaumium", "springSmallThaumium" });
