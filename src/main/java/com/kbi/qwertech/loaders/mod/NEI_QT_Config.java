...
@InterfaceList(value = { @Interface(iface = "codechicken.nei.api.IConfigureNEI", modid = "NotEnoughItems") })
public class NEI_QT_Config implements codechicken.nei.api.IConfigureNEI {
    ...
    public void loadConfig() {
        ...
        FMLInterModComms.sendRuntimeMessage(
            ...
            MD.GAPI.mID + "@" + chisel.getRecipeName() + "@" + chisel.getOverlayIdentifier());
        ...
        if (CODE_CLIENT) {
            ...
            codechicken.nei.api.API.registerGuiOverlayHandler(
                GUIClientAdvancedCraftingTable.class,
                new codechicken.nei.recipe.DefaultOverlayHandler(55, 11),
                "crafting");
            codechicken.nei.api.API.registerGuiOverlay(GUIClientAdvancedCraftingTable2.class, "crafting", 80, 17);
            codechicken.nei.api.API.registerGuiOverlayHandler(
                GUIClientAdvancedCraftingTable2.class,
                new codechicken.nei.recipe.DefaultOverlayHandler(55, 11),
                "crafting");
            // codechicken.nei.api.API.registerGuiOverlay(GUIClientAdvancedCraftingTable3.class, "crafting", 80, 17);
            // codechicken.nei.api.API.registerGuiOverlayHandler(GUIClientAdvancedCraftingTable3.class, new
            // codechicken.nei.recipe.DefaultOverlayHandler(55, 11), "crafting");
        }
        sIsAdded = true;
    }
