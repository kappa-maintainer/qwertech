...
public class ModLoad_TFC extends ModLoadBase {
    ...
    public void addOreDict() {
        ...
        String[] oreNames = new String[] { "Oak", "Aspen", "Birch", "Chestnut", "DouglasFir", "Hickory", "Maple", "Ash",
            "Pine", "Sequoia", "Spruce", "Sycamore", "WhiteCedar", "WhiteElm", "Willow", "Kapok", "Acacia" };
        String[] blockNames = new String[] { "planks", "planks", "planks", "planks", "planks", "planks", "planks",
            "planks", "planks", "planks", "planks", "planks", "planks", "planks", "planks", "planks", "planks2" };
