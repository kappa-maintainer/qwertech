...
public class ModLoad_NAT extends ModLoadBase {
    ...
    public void addOreDict() {
        ...
        String[] oreNames = new String[] { "Eucalyptus", "Sakura", "Ghostwood", "Redwood", "Bloodwood", "Hopseed",
            "Maple", "Silverbell", "Purpleheart", "Tiger", "Willow", "Dark", "Fusewood" };
        String[] blockNames = new String[] { "natura.planks", "natura.planks", "natura.planks", "natura.planks",
            "natura.planks", "natura.planks", "natura.planks", "natura.planks", "natura.planks", "natura.planks",
            "natura.planks", "natura.planks", "natura.planks" };
