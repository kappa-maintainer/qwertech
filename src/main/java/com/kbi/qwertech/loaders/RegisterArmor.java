...
import com.kbi.qwertech.armor.upgrades.Upgrade_ThaumicGoggles;
...
public class RegisterArmor {
    ...
    public RegisterArmor() {
        ...
        armor.addArmor(
            0,
            "Chain Helmet",
            "Rattles worse than bones",
            new HelmetBase().setMaterialAmount(CS.U * 6),
            "armorHelmet");
        armor.addArmor(
            1,
            "Chainmail Shirt",
            "Thy mother was a hamster!",
            new ChestBase().setMaterialAmount(CS.U * 9),
            "armorChest");
        armor.addArmor(
            2,
            "Chainmail Leggings",
            "Thy father smelt of elderberries!",
            new PantBase().setMaterialAmount(CS.U * 8),
            "armorLegs");
        armor
            .addArmor(3, "Chain Boots", "Linked to the Past", new BootBase().setMaterialAmount(CS.U * 4), "armorBoots");
        armor.addArmor(
            4,
            "Plated Helmet",
            "Always wear your helmet",
            new HelmetPlate().setMaterialAmount(CS.U * 10),
            "armorHelmet");
        armor
            .addArmor(5, "Chestplate", "The classic look", new ChestPlate().setMaterialAmount(CS.U * 14), "armorChest");
        armor.addArmor(
            6,
            "Plated Pants",
            "Not to be confused with pleated pants",
            new PantPlate().setMaterialAmount(CS.U * 14),
            "armorLegs");
        armor.addArmor(
            7,
            "Plated Boots",
            "Clanky and clunky",
            new BootPlate().setMaterialAmount(CS.U * 6),
            "armorBoots");
                ...
                if (upgrade != null) {
                    ...
                    if (drawIt != null) {
                        ...
                        if (texture != null) {
                            ...
                            drawIt.setLivingAnimations(
                                event.entityLiving,
                                event.entityLiving.limbSwing - event.entityLiving.limbSwingAmount,
                                event.entityLiving.prevLimbSwingAmount
                                    + (event.entityLiving.limbSwingAmount - event.entityLiving.prevLimbSwingAmount),
                            ...
                            drawIt.render(
                                ...
                                event.entityLiving.prevLimbSwingAmount
                                    + (event.entityLiving.limbSwingAmount - event.entityLiving.prevLimbSwingAmount),
                                event.entityLiving.ticksExisted,
                                event.entityLiving.rotationYawHead - event.entityLiving.renderYawOffset,
                                event.entityLiving.prevRotationPitch
                                    + (event.entityLiving.rotationPitch - event.entityLiving.prevRotationPitch),
                                0.0625F);
                        }
                        GL11.glColor4f(1F, 1F, 1F, 1F);
                    }
    ...
    public void onClickedWearingArmor(PlayerInteractEvent event) {
        for (int q = 1; q < 5; q++) {
            ...
            if (armor != null && armor.getItem() instanceof MultiItemArmor) {
                ((MultiItemArmor) armor.getItem()).onClickedWearing(
                    armor,
                    q,
                    event.world,
                    event.entityPlayer,
