...
public class RegisterAchievements {
    ...
    public RegisterAchievements() {
        ...
        ItemStack shuriken = OreDictPrefix.get("shuriken")
            .mat(MT.Fe, 1);
        ...
        achievementAges
            .put("stoneAge", registerAchievement("stoneAge", 5, -6, new ItemStack(Blocks.furnace), null, true, 0));
        achievementAges.put(
            "rockstart",
            registerAchievement("rockyStart", 5, -4, rock, achievementAges.get("stoneAge"), false, 5));
        achievementAges.put(
            "pickUpFlint",
            registerAchievement(
                "pickUpFlint",
                ...
                achievementAges.get("rockstart"),
                false,
                5));
        achievementAges.put(
            "craftHammer",
            registerAchievement("craftHammer", 3, -4, marbleHammer, achievementAges.get("rockstart"), false, 15));
        achievementAges.put(
            "dryGrass",
            registerAchievement("dryGrass", 7, -6, dryGrass, achievementAges.get("pickUpFlint"), false, 15));
        achievementAges.put(
            "fireStarter",
            registerAchievement("fireStarter", 9, -6, fireStarter, achievementAges.get("dryGrass"), false, 10));
        achievementAges.put(
            "crushOre",
            registerAchievement("crushOre", 1, -4, crushed, achievementAges.get("craftHammer"), false, 15));
        achievementAges.put(
            "stoneCraft",
            registerAchievement("stoneCraft", 3, -6, stoneCraft, achievementAges.get("craftHammer"), false, 25));
        achievementAges.put(
            "hammerPlate",
            registerAchievement("hammerPlate", 1, -6, plate, achievementAges.get("stoneCraft"), false, 25));
        achievementAges.put(
            "craftFile",
            registerAchievement("craftFile", -1, -4, file, achievementAges.get("hammerPlate"), false, 15));
        achievementAges
            .put("useMace", registerAchievement("useMace", -3, -4, mace, achievementAges.get("craftFile"), false, 25));
        achievementAges.put(
            "craftWrench",
            registerAchievement("craftWrench", -1, -6, wrench, achievementAges.get("hammerPlate"), false, 15));
        achievementAges.put(
            "craftChisel",
            registerAchievement("craftChisel", -1, -2, chisel, achievementAges.get("craftFile"), false, 25));
        achievementAges.put(
            "craftMold",
            registerAchievement("craftMold", 1, -2, mold, achievementAges.get("craftChisel"), false, 25));
        achievementAges.put(
            "moldPlate",
            registerAchievement("moldPlate", 2, -3, plateMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldIngot",
            registerAchievement("moldIngot", 3, -3, ingotMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldRod",
            registerAchievement("moldRod", 4, -3, stickMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldLongRod",
            registerAchievement("moldLongRod", 5, -3, longRodMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldChunk",
            registerAchievement("moldChunk", 6, -3, chunkMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldRing",
            registerAchievement("moldRing", 7, -3, ringMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldItemCasing",
            registerAchievement("moldItemCasing", 8, -3, itemCasingMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldGear",
            registerAchievement("moldGear", 9, -3, gearMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldSmallGear",
            registerAchievement("moldSmallGear", 10, -3, smallGearMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldBolt",
            registerAchievement("moldBolt", 11, -3, boltMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldTinyPlate",
            registerAchievement("moldTinyPlate", 12, -3, tinyPlateMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldArrow",
            registerAchievement("moldArrow", 13, -3, arrowMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldSpade",
            registerAchievement("moldSpade", 14, -3, spadeMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldPickaxe",
            registerAchievement("moldPickaxe", 2, -2, pickaxeMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldShovel",
            registerAchievement("moldShovel", 3, -2, shovelMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldAxe",
            registerAchievement("moldAxe", 4, -2, axeMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldSword",
            registerAchievement("moldSword", 5, -2, swordMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldHammer",
            registerAchievement("moldHammer", 7, -2, hammerMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldHoe",
            registerAchievement("moldHoe", 6, -2, hoeMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldFile",
            registerAchievement("moldFile", 8, -2, fileMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldChisel",
            registerAchievement("moldChisel", 9, -2, chiselMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldScrewdriver",
            registerAchievement(
                "moldScrewdriver",
                ...
                -2,
                screwdriverMold,
                achievementAges.get("craftMold"),
                false,
                10));
        achievementAges.put(
            "moldSaw",
            registerAchievement("moldSaw", 11, -2, sawMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldSense",
            registerAchievement("moldSense", 12, -2, senseMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldPlow",
            registerAchievement("moldPlow", 13, -2, plowMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldDoubleAxe",
            registerAchievement("moldDoubleAxe", 14, -2, doubleAxeMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldUniversalSpade",
            registerAchievement("moldUniversalSpade", 15, -3, uSpadeMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldMattock",
            registerAchievement("moldMattock", 15, -2, mattockMold, achievementAges.get("craftMold"), false, 10));
        achievementAges.put(
            "moldMace",
            registerAchievement("moldMace", 16, -3, maceMold, achievementAges.get("craftMold"), false, 10));

        achievementAges.put(
            "bronzeAge",
            registerAchievement("bronzeAge", 5, -1, bronzeGear, achievementAges.get("craftMold"), true, 25));
        achievementAges.put(
            "bronzeCraft",
            registerAchievement("bronzeCraft", 8, -1, bronzeCraft, achievementAges.get("bronzeAge"), true, 25));
        achievementAges.put(
            "craftBoiler",
            registerAchievement("craftBoiler", 3, 0, boiler, achievementAges.get("bronzeAge"), false, 20));
        achievementAges.put(
            "craftTurbine",
            registerAchievement("craftTurbine", 7, 0, turbine, achievementAges.get("bronzeAge"), false, 20));
        achievementAges.put(
            "craftRollingMill",
            registerAchievement("craftRollingMill", 6, 1, rollMill, achievementAges.get("bronzeAge"), false, 15));
        achievementAges.put(
            "craftLathe",
            registerAchievement("craftLathe", 4, 1, lathe, achievementAges.get("bronzeAge"), false, 15));
        achievementAges.put(
            "craftRollBender",
            registerAchievement("craftRollBender", 8, 1, rollBender, achievementAges.get("bronzeAge"), false, 15));
        achievementAges.put(
            "craftCrusher",
            registerAchievement("craftCrusher", 2, 1, crusher, achievementAges.get("bronzeAge"), false, 20));
        achievementAges.put(
            "craftCompressor",
            registerAchievement("craftCompressor", 3, 2, compressor, achievementAges.get("bronzeAge"), false, 20));
        achievementAges.put(
            "craftSqueezer",
            registerAchievement("craftSqueezer", 5, 2, squeezer, achievementAges.get("bronzeAge"), false, 20));
        achievementAges.put(
            "craftShredder",
            registerAchievement("craftShredder", 7, 2, shredder, achievementAges.get("bronzeAge"), false, 20));

        achievementList.put(
            "stoneWeapon",
            registerAchievement("stoneWeapon", 0, -6, stonePick, achievementAges.get("rockstart"), false, 50));
        achievementList.put(
            "cookCow",
            registerAchievement("cookCow", 0, -5, hamburger, achievementAges.get("pickUpFlint"), false, 25));
        achievementList.put(
            "explodeOverheat",
            registerAchievement("explodeOverheat", 0, -4, burningBox, achievementAges.get("craftChisel"), false, 50));
        achievementList.put(
            "knuckleDuster",
            registerAchievement("knuckleDuster", 0, -3, knuckles, achievementAges.get("hammerPlate"), false, 20));
        achievementList.put(
            "brokenWindow",
            registerAchievement("brokenWindow", 0, -2, slingshot, achievementAges.get("rockstart"), false, 25));
        achievementList.put(
            "rustyBreak",
            registerAchievement("rustyBreak", 1, -6, doubleAxe, AchievementList.killEnemy, false, 20));
        achievementList.put(
            "batterUp",
            registerAchievement("batterUp", 1, -5, bat, achievementAges.get("craftChisel"), false, 15));
        achievementList.put(
            "mudSplat",
            registerAchievement("mudSplat", 1, -4, mudBall, achievementAges.get("rockstart"), false, 10));
        achievementList.put(
            "ninjaStrike",
            registerAchievement("ninjaStrike", 1, -3, shuriken, achievementAges.get("craftFile"), false, 50));
        achievementList.put(
            "kingBat",
            registerAchievement("kingBat", 1, -2, batOnBat, achievementList.get("batterUp"), false, 50));
        achievementList.put(
            "deflectKill",
            registerAchievement("deflectKill", 2, -6, splashPot, achievementList.get("batterUp"), false, 33));
        achievementList.put(
            "peckish",
            registerAchievement("peckish", 2, -5, turkeyMeat, achievementAges.get("rockstart"), false, 25));

        AchievementPage.registerAchievementPage(
            new AchievementPage(
                "QwerTech Progression",
                this.achievementAges.values()
                    .toArray(new Achievement[this.achievementAges.size()])));
        AchievementPage.registerAchievementPage(
            new AchievementPage(
                "QwerTech Challenges",
    ...
    public void onAchieved(AchievementEvent event) {
        ...
        if ((!ep.func_147099_x()
            ...
            && ((event.achievement.parentAchievement == null) || (ep.func_147099_x()
                .hasAchievementUnlocked(event.achievement.parentAchievement)))) {
            if (QTConfigs.announceFanfare) {
                if (event.achievement == AchievementList.openInventory || event.achievement == AchievementList.mineWood
                    || event.achievement == AchievementList.buildWorkBench
                    || event.achievement == AchievementList.buildPickaxe
                    || event.achievement == achievementAges.get("stoneAge")
                    || event.achievement == achievementAges.get("rockstart")) {} else
    ...
    public void onRightClick(PlayerInteractEvent event) {
        if (event.action == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (bc.getName()
                .equals("gregapi.block.multitileentity.MultiTileEntityBlock")) {
                ...
                if (event.world.getTileEntity(event.x, event.y, event.z) != null) {
                    Class TE = event.world.getTileEntity(event.x, event.y, event.z)
                        .getClass();
                    if (TE.getName()
                        .equals("gregtech.tileentity.tools.MultiTileEntityMold")) {
                        TileEntityBase07Paintable moldTE = (MultiTileEntityMold) event.world
                            .getTileEntity(event.x, event.y, event.z);
                        if (moldTE.slot(0) != null && moldTE.canExtractItem2(0, moldTE.slot(0), (byte) 0)
                            ...
                            } else if (OreDictPrefix.get("toolHeadMattock")
                                .contains(moldTE.slot(0))) {
                                    issueAchievement(event.entityPlayer, "moldMattock");
                                } else if (OreDictPrefix.get("toolHeadMace")
                                    .contains(moldTE.slot(0))) {
    ...
    public void onCrafted(PlayerEvent.ItemCraftedEvent event) {
        ...
        if (result != null) {
            ...
            if (OreDictManager.isItemStackInstanceOf(result, "craftingToolHardHammer")) {
                ...
                String MachineType = mte.getClass()
                    .getName();
                ...
                } else if (MachineType.toLowerCase()
                    .contains(("crafting"))) {
    ...
    public ItemStack onItemFinish(PlayerUseItemEvent.Stop event) {
        if (OreDictManager.isItemStackInstanceOf(event.item, "toolSlingshot") && (72000 - event.duration) > 10) { // useless
                                                                                                                  // for
                                                                                                                  // now
            Behavior_Slingshot BS = (Behavior_Slingshot) qwerTool.mItemBehaviors.get((short) event.item.getItemDamage())
                .get(0);
            ...
            for (int q = 0; q < inventory.length; q++) {
                if (inventory[q] != null) {
                    if (OP.rockGt.contains(inventory[q])) {
                        ...
                        type = 4;
                        break;
                    } else if ((inventory[q]).getItem() == IL.Mud_Ball.getItem()
                        && (inventory[q]).getItemDamage() == IL.Mud_Ball.get(1, (Object[]) null)
                            .getItemDamage()) {
                                ammo = inventory[q];
                                slot = q;
                                type = 5;
                        ...
                        if (OreDictManager.isItemStackInstanceOf(inventory[q], "cropTomato")) {
                            ammo = inventory[q];
                            slot = q;
                            type = 6;
                        } else {
            ...
            if (ammo != null) {
                if ((BS.mDamage > 0L) && (!UT.Entities.hasInfiniteItems(event.entityPlayer))) {
                    ((MultiItemTool) event.item.getItem())
                        .doDamage(event.item, UT.Code.units(BS.mDamage, 10000L, BS.mDamage, true), event.entityPlayer);
                ...
                if (!(event.entityPlayer.worldObj.isRemote)) {
                    if (type == (short) 3) {
                        event.entityPlayer.worldObj
                            .spawnEntityInWorld(new EntityEgg(event.entityPlayer.worldObj, event.entityPlayer));
                    } else if (type >= (short) 4 && type <= (short) 6) {
                        EntityBall entityBall = new EntityBall(
                            event.entityPlayer.worldObj,
                            event.entityPlayer,
                            Math.min(50, 72000 - event.duration) / 20,
                            MT.Empty,
                            type);
                        if (MultiItemTool.getPrimaryMaterial(event.item)
                            .contains(TD.Properties.BURNING)) {
                            entityBall.setFire(20);
                        }
                        event.entityPlayer.worldObj.spawnEntityInWorld(entityBall);
                    } else if (type == (short) 2) {
                        EntityFoil entityFoil = new EntityFoil(
                            event.entityPlayer.worldObj,
                            event.entityPlayer,
                            Math.min(50, 72000 - event.duration) / 20,
                            OM.anydata(ammo).mMaterial.mMaterial,
                            type);
                        if (MultiItemTool.getPrimaryMaterial(event.item)
                            .contains(TD.Properties.BURNING)) {
                        ...
                        EntityRock entityRock = new EntityRock(
                            event.entityPlayer.worldObj,
                            event.entityPlayer,
                            Math.min(50, 72000 - event.duration) / 25,
                            OM.anydata(ammo).mMaterial.mMaterial,
                            type);
                        if (MultiItemTool.getPrimaryMaterial(event.item)
                            .contains(TD.Properties.BURNING)) {
