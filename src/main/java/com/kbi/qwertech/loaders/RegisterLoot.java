...
public class RegisterLoot {
    ...
    public static void init() {
        ...
        OreDictMaterial[] mats = new OreDictMaterial[] { MT.Steel, MT.Bronze, MT.BlackSteel, MT.BlackBronze,
            MT.WroughtIron, MT.Au, MT.Ag };
        ...
        RegisterLoot jungleShooter = new RegisterLoot("pyramidJungleDispenser").addItem(star.mat(MT.Steel, 1), 16, 2)
            .addItem(star.mat(MT.Ag, 1), 16, 1)
            .addItem(star.mat(MT.Pb, 1), 16, 1)
            .addItem(star.mat(MT.Bronze, 1), 16, 2)
            .addItem(star.mat(MT.Ti, 1), 16, 1);
        ...
        RegisterLoot village = new RegisterLoot("villageBlacksmith").addItem(star.mat(MT.Steel, 1), 16, 2)
            .addItem(star.mat(MT.Fe, 1), 16, 2)
            .addItem(star.mat(MT.Bronze, 1), 16, 1)
            .addItem(star.mat(MT.DamascusSteel, 1), 16, 1)
            .addItem(star.mat(MT.BlueSteel, 1), 16, 1)
            .addItem(star.mat(MT.RedSteel, 1), 16, 1);
        ...
        for (int q = 0; q < mats.length; q++) {
            village.addItem(gt.getToolWithStats(2, mats[q], mats[q].mHandleMaterial))
                .addItem(gt.getToolWithStats(58, mats[q], mats[q].mHandleMaterial))
                .addItem(gt.getToolWithStats(12, mats[q], mats[q].mHandleMaterial))
                .addItem(gt.getToolWithStats(36, mats[q], mats[q].mHandleMaterial))
                .addItem(gt.getToolWithStats(0, mats[q], mats[q].mHandleMaterial))
                .addItem(qt.getToolWithStats(0, mats[q], mats[q].mHandleMaterial))
                .addItem(qt.getToolWithStats(6, mats[q], mats[q].mHandleMaterial))
                .addItem(qt.getToolWithStats(12, MT.Brass, mats[q]));
            ...
            strong1.addItem(gt.getToolWithStats(0, mats[q], mats[q].mHandleMaterial))
                .addItem(gt.getToolWithStats(6, mats[q], mats[q].mHandleMaterial));
        }
    }
