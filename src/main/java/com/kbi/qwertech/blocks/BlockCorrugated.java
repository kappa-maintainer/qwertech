...
public class BlockCorrugated extends BlockBaseMeta {
    ...
    public BlockCorrugated(Class<? extends ItemBlock> aItemClass, String aNameInternal, Material aMaterial,
    ...
    public void addCollisionBoxesToList(World world, int x, int y, int z, AxisAlignedBB aabb, List list,
        Entity entity) {
        boolean flag2 = world.isSideSolid(x - 1, y, z, ForgeDirection.WEST, true)
            || world.getBlock(x - 1, y, z) == this;
        boolean flag3 = world.isSideSolid(x + 1, y, z, ForgeDirection.EAST, true)
            || world.getBlock(x + 1, y, z) == this;
        boolean flag = world.isSideSolid(x, y, z - 1, ForgeDirection.SOUTH, true)
            || world.getBlock(x, y, z - 1) == this;
        boolean flag1 = world.isSideSolid(x, y, z + 1, ForgeDirection.NORTH, true)
            || world.getBlock(x, y, z + 1) == this;
        float f = 0.375F;
        float f1 = 0.625F;
        float f2 = 0.375F;
