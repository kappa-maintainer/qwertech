...
public class MultiItemTool_QT extends MultiItemTool {
    ...
    public boolean onEntitySwing(EntityLivingBase entity, ItemStack stack) {
        ...
        if (isAOE) {
            ...
            float f1 = 1F;
            List list = entity.worldObj.getEntitiesWithinAABBExcludingEntity(
                entity,
                entity.boundingBox.addCoord(vec31.xCoord * 2, vec31.yCoord * 2, vec31.zCoord * 2)
                    .expand(f1, f1, f1)
                ...
                if ((list.get(q) instanceof EntityLivingBase && ((EntityLivingBase) list.get(q)).hurtTime > 0)) {
                    ...
                    if (entity instanceof EntityPlayer) {
                        ...
                        FakePlayer player = FakePlayerFactory.get(
                            ...
                            new GameProfile(new UUID('0', '0'), entity.getCommandSenderName()));
