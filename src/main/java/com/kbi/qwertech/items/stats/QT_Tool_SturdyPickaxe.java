...
public class QT_Tool_SturdyPickaxe extends GT_Tool_Pickaxe {
     ...
     * }
     * @Override
     * public int convertBlockDrops(List<ItemStack> aDrops, ItemStack aStack, EntityPlayer aPlayer, Block aBlock, long
     * aAvailableDurability, int aX, int aY, int aZ, byte aMetaData, int aFortune, boolean aSilkTouch,
