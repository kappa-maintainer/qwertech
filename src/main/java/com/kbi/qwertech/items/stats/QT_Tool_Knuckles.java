...
public class QT_Tool_Knuckles extends ToolStats {
    ...
    public int convertBlockDrops(List<ItemStack> aDrops, ItemStack aStack, EntityPlayer aPlayer, Block aBlock,
        ...
        if (!((aBlock instanceof BlockTorch) || (aBlock instanceof BlockButton)
            || (aBlock instanceof BlockPressurePlate)
            || (aBlock instanceof BlockRedstoneWire)
            || (aBlock instanceof BlockTripWire)
            ...
            if (aBlock.getMaterial() == Material.sand || aBlock.getMaterial() == Material.ground
