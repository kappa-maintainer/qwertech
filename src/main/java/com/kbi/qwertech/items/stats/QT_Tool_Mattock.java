...
public class QT_Tool_Mattock extends ToolStats {
    ...
    public int convertBlockDrops(List<ItemStack> aDrops, ItemStack aStack, EntityPlayer aPlayer, Block aBlock,
        ...
        if (((aBlock.getMaterial() == Material.ice) || (aBlock.getMaterial() == Material.packedIce))
            && (aDrops.isEmpty())) {
    ...
    public boolean isMinableBlock(Block aBlock, byte aMetaData) {
        ...
        return ((tTool != null) && ((tTool.equalsIgnoreCase("axe")) || (tTool.equalsIgnoreCase("saw"))))
    ...
    public IIconContainer getIcon(boolean aIsToolHead, ItemStack aStack) {
        return aIsToolHead
            ? MultiItemTool.getPrimaryMaterial(aStack, MT.Steel).mTextureSetsItems
                .get(gregapi.oredict.OreDictPrefix.get("toolHeadMattock").mIconIndexItem)
