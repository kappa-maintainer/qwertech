...
public class QT_Tool_Bat extends ToolStats {
    ...
    public IIconContainer getIcon(boolean aIsToolHead, ItemStack aStack) {
        ...
        return aIsToolHead
            ? MultiItemTool.getSecondaryMaterial(aStack, MT.Steel).mTextureSetsItems.get(QwerTech.batSpikeTexID)
            : MultiItemTool.getPrimaryMaterial(aStack, MT.Wood).mTextureSetsItems.get(QwerTech.batTexID);
    }
    ...
    public short[] getRGBa(boolean aIsToolHead, ItemStack aStack) {
        ...
        return aIsToolHead ? MultiItemTool.getSecondaryMaterial(aStack, MT.Steel).mRGBaSolid
            : MultiItemTool.getPrimaryMaterial(aStack, MT.Wood).mRGBaSolid;
    }
