...
public class CraftingHelper extends TileEntityBase04MultiTileEntities implements
    IMultiTileEntity.IMTE_GetCollisionBoundingBoxFromPool, IMultiTileEntity.IMTE_GetPlayerRelativeBlockHardness,
    IMultiTileEntity.IMTE_SetBlockBoundsBasedOnState, IMultiTileEntity.IMTE_OnEntityCollidedWithBlock,
    IMultiTileEntity.IMTE_OnToolClick, IMultiTileEntity.IMTE_OnBlockClicked, IMultiTileEntity.IMTE_RemovedByPlayer,
    ITileEntityOnDrawBlockHighlight, IMultiTileEntity.IMTE_CanEntityDestroy, IMultiTileEntity.IMTE_GetBlocksMovement,
    ...
    public long onToolClick(String aTool, long aRemainingDurability, long aQuality, Entity aPlayer,
        ...
        return getTable() != null ? getTable().onToolClick(
            aTool,
