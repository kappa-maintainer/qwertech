...
public class CraftingTableT2 extends CraftingTableT1 implements IMultiTileEntity.IMTE_SyncDataByte {
    ...
    public void onTick2(long aTimer, boolean aIsServerSide) {
         ...
         * {
         * getNetworkHandler().sendToAllPlayersInRange(new PacketSyncDataByte(getCoords(), damage), worldObj,
         * getCoords());
         * }
         * }
         */
    ...
    public ITexture getTexture2(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
        return BlockTextureMulti.get(
            super.getTexture2(aBlock, aRenderPass, aSide, aShouldSideBeRendered),
            BlockTextureDefault.get(cracks[damage], mRGBa));
    }
            ...
            if (this.slotHas(10)) {
                ...
                if (droppable != null && !worldObj.isRemote) {
                    worldObj.spawnEntityInWorld(
                        new EntityItem(worldObj, xCoord + 0.5, yCoord + 1.5, zCoord + 0.5, droppable));
                }
                getNetworkHandler()
                    .sendToAllPlayersInRange(new PacketSyncDataByte(getCoords(), damage), worldObj, getCoords());
                return 10000;
            }
        }
        return 0;
    ...
    public Object getGUIClient2(int aGUIID, EntityPlayer aPlayer) {
        return new GUIClientAdvancedCraftingTable2(aPlayer.inventory, this);
    }
