...
public class EntityBall extends EntityRock {
    ...
    public EntityBall(World p_i1755_1_, EntityLivingBase p_i1755_2_, float p_i1755_4_, OreDictMaterial mt,
        short rockType) {
            ...
            if (!(this.worldObj.isRemote)) {
                if (this.getType() == 4) {
                    mop.entityHit.attackEntityFrom(
                        (new EntityDamageSourceIndirect("thrownSlime", this, this.getThrower())).setProjectile(),
                        this.getDamage());
                } else if (this.getType() == 5) {
                    mop.entityHit.attackEntityFrom(
                        (new EntityDamageSourceIndirect("thrownMud", this, this.getThrower())).setProjectile(),
                        this.getDamage());
                }
