...
public class EntityAIMoveTowardsSimpleTarget extends EntityAIBase {
    ...
    public boolean continueExecuting() {
        return !this.theEntity.getNavigator()
            .noPath() && this.targetEntity != null
            && this.targetEntity.worldObj == this.theEntity.worldObj
    ...
    public void startExecuting() {
        this.theEntity.getNavigator()
            .tryMoveToXYZ(this.movePosX, this.movePosY, this.movePosZ, this.theEntity.getAIMoveSpeed());
    }
}
